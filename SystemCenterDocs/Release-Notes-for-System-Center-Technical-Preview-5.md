...
**Workaround:** See [Upgrade to Service Manager Technical Preview](Upgrade-to-Service-Manager-Technical-Preview.md) for information about deploying the Self Service portal.
