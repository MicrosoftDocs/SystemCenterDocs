...
|Wizards Available|
|---------------------|
|Simple Event Detection using each of the standard [Event Monitor Reset](../Topic/Event-Monitor-Reset.md) methods|
|Repeated Event Detection using each of the standard [Event Monitor Reset](../Topic/Event-Monitor-Reset.md) methods|
|Missing Event Detection using each of the standard [Event Monitor Reset](../Topic/Event-Monitor-Reset.md) methods|
|Correlated Event Detection using each of the standard [Event Monitor Reset](../Topic/Event-Monitor-Reset.md) methods|
|Correlated Missing Event Detection using each of the standard [Event Monitor Reset](../Topic/Event-Monitor-Reset.md) methods|
...
[Event Monitor Logic](../Topic/Event-Monitor-Logic.md)
