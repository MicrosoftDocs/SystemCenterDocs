...
-   The [!INCLUDE[vmm12short](../Token/vmm12short_md.md)] guest agent for Linux must be installed on the virtual machine. It is required for service template integration, and it allows you to modify properties on the Linux computer such as the host name. For information about installation, see [How to install the VMM agent for Linux](../Topic/How-to-install-the-VMM-agent-for-Linux.md).
