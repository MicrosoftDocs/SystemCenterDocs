...
-   [How to Create a Management Pack File](./How-to-Create-a-Management-Pack-File.md)

    Describes how to create a management pack file.

-   [How to Export a Management Pack](./How-to-Export-a-Management-Pack.md)
...
-   [How to Import the Operations Manager Alert Cube Management Pack](./How-to-Import-the-Operations-Manager-Alert-Cube-Management-Pack.md)
