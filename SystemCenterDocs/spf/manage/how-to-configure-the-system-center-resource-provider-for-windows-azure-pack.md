...
-   UsageEndPoint  
    ...
    The usage endpoint is registered separately in Windows Azure Pack for Windows Server and API but takes the same base URL. For more information about configuring usage metering, see [Configure Usage Metering in Service Provider Foundation](Configure-Usage-Metering-in-Service-Provider-Foundation.md).  
