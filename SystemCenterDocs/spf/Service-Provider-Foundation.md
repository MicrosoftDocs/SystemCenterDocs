...
---
# Service Provider Foundation
Service Provider Foundation is provided with  [!INCLUDE[scor_threshold_1](../includes/scor_threshold_1_md.md)]. Service Provider Foundation exposes an extensible OData web service that interacts with Virtual Machine Manager \(VMM\). This enables service providers and hosters to design and implement multi\-tenant self\-service portals that integrate IaaS capabilities with [!INCLUDE[sc_threshold_1](../includes/sc_threshold_1_md.md)].
