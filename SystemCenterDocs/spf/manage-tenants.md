...
3. This command puts the certificate in the Current User Certificate Store. To access it, on **Start** screen, enter **certmgr.msc** and then in the **Apps** results, select **certmgr.msc**.   In the **certmgr** window, select **Certificates \- Current User** > **Personal** > **Certificates** folder.  
