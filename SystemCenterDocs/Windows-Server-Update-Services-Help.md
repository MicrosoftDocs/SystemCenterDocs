...
<developerConceptualDocument xmlns="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://ddue.schemas.microsoft.com/authoring/2003/5 http://dduestorage.blob.core.windows.net/ddueschema/developer.xsd">
  <introduction>
    ...
    <para>Prior to <token>win8_server_Token>, WSUS was not, by default, part of the server operating system; installation required that you first download the WSUS software from the Microsoft Download Center. Starting in <token>win8_server_Token>, WSUS is integrated with the server operating system as a server role.</para>
  </introduction>
  <section>
    ...
    <content>
      ...
      <para>For information about migrating WSUS 3.0 SP2 to <token>winblue_server_Token> and <token>win8_server_Token>, see:</para>
      <list class="bullet">
        <listItem>
          <para>
            <externalLink>
      ...
      <para>For information about deploying WSUS in <token>winblue_server_Token> and <token>win8_server_Token>, see:</para>
      <list class="bullet">
        <listItem>
          <para>
            <externalLink>
