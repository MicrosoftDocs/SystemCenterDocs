...
To begin monitoring, computers must be discovered. For a description of the discovery process, see “How Objects Are Discovered and Monitored” in [Key Concepts](Operations-Manager-Key-Concepts.md).
...
-   [General Tasks in Operations Manager](../Topic/General-Tasks-in-Operations-Manager.md)
