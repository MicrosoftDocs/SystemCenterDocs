...
Authoring is described in detail in the [Operations Manager 2012 Authoring Guide](https://social.technet.microsoft.com/wiki/contents/articles/15251.system-center-management-pack-authoring-guide.aspx). The sections below describe the different options in the Authoring workspace.  
