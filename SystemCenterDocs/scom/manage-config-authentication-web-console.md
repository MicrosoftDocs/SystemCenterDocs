...
>
> If you are experiencing issues with authentication prompts when attempting to access the Web console, ensure that the fully qualified domain name (FQDN) URL is included in **Local Intranet Sites** in Internet Explorer.
