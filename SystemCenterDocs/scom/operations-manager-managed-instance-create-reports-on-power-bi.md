...
1. Review the **Prerequisites** section to ensure Public endpoint of SQL MI Instance is enabled. You will notice the Database Host URL and Database name are displayed.
