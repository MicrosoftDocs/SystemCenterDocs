...
|Watcher node event log issues|If a managed instance isn't available, multiple errors appear in the watcher node event log. These errors will keep coming until the managed instance is available.|No resolution.|
