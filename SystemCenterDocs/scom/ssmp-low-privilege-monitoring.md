...
1. [Import SQL Server Management Pack](ssmp-management-pack-delivery.md).
...
To configure low-privilege [mixed monitoring](ssmp-monitoring-modes.md#configuring-mixed-monitoring-mode), perform the steps described in the [Agent Monitoring](#agent-monitoring) section and do the following:
