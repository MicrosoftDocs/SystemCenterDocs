...
**Note**: SQL Server 2025 is supported only starting with [SCOM 2025 Update Rollup 1 (UR1)](https://support.microsoft.com/en-US/servicing/management-tools/operations-manager/update/2025/09/update-rollup-1-for-system-center-operations-manager-2025).
