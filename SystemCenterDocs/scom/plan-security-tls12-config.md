...
>[!NOTE]
> Operations Manager 2016 UR9 supports MSOLEDBSQL (recommended use).  
::: moniker-end

1. Install [SQL Server 2012 Native Client 11.0](https://www.microsoft.com/download/details.aspx?id=50402&751be11f-ede8-5a0c-058c-2ee190a24fa6=True) or [MSOLEDBSQL](https://www.microsoft.com/download/details.aspx?id=56730) on all management servers and the Web console server.  
