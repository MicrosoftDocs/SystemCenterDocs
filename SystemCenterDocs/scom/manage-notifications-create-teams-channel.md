...
- Run As account. For more information see [How to create and configure the Notification action account](/system-center/scom/manage-notifications-create-configure). Delegated API type is used in Teams integration and the Rus As account credentials will be used to authenticate.
