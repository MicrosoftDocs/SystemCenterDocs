...
There is no limit on the maximum number of management servers per management group. However, it is a best practice to use as few management servers as possible after addressing scalability, high availability, and disaster recovery constraints.
