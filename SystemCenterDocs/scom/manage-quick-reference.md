...
|[Integrate with Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/platform/om-agents)|Azure Monitor logs provides an analytics platform that compliments the Data Warehouse to deliver improved analytics, query performance across large data volumes, correlate log data Azure resources, and longer retention of monitoring data.| 
||
