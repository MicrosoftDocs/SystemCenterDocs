...
|Management group maintenance|-  [Monitor health of the management group](manage-monitor-health-mg.md)<br>-  [How to clear the cache](manage-clear-healthservice-cache.md)<br>-  [How to configure communication with SQL Server](manage-sqlserver-communication.md)<br>-  [How to move the Operational database](manage-move-opsdb.md)<br>-  [How to move the Reporting DW database](manage-move-omdwdb.md)<br>-  [How to configure grooming for the Operational database](manage-omdb-grooming-settings.md)<br>-  [How to configure grooming for the Reporting DW database](manage-omdwdb-grooming-settings.md)|
|||
