...
title: Adjusting Datacenter Dashboard
...
![Datacenter view personalization](./media/ssdmp/datacenter-view-personalization.png)
...
![Instance paths](./media/ssdmp/instance-paths.png)
...
![Contrast mode](./media/ssdmp/contrast-theme.png)
...
![Highlighting of fields](./media/ssdmp/highlighting.png)
...
![Removing information from the field](./media/ssdmp/removing-information.png)
...
![Expand a group](./media/ssdmp/expanding-group.png)
...
![Expanded mode](./media/ssdmp/expanded-mode.png)
...
![Removal of tiles](./media/ssdmp/removing-tiles.png)

All other tiles (3 types of alerts) can be only removed in the context menu.

![Removal of other tiles](./media/ssdmp/removing-other-tiles.png)

Note that if all tiles are removed, the group widget looks as follows:

![Group widget](./media/ssdmp/all-tiles-removed.png)
...
![Enabled state](./media/ssdmp/enabled-states-menu.png)
...
![Default settings](./media/ssdmp/reset-ro-default.png)
...
![Enabled state tiles](./media/ssdmp/enabled-states.png)
...
![Aggregated tiles](./media/ssdmp/aggregated-tiles.png)
...
![New aggregated tile](./media/ssdmp/adding-aggregated-tiles.png)
...
![Aggregated monitor tile](./media/ssdmp/aggregated-monitor.png)
...
![Showing tooltips](./media/ssdmp/tooltips.png)
...
![Performance tile](./media/ssdmp/add-aggregated-performance-tile.png)
...
![Modify tile](./media/ssdmp/edit-tile.png)
...
![Displayed widget](./media/ssdmp/centered-widget.png)
...
![Performance tile tooltip](./media/ssdmp/performance-tile-tooltip.png)

## Adding Virtual Group

A virtual group with many classes can be added to Datacenter Dashboard.

![New virtual group](./media/ssdmp/adding-virtual-group.png)