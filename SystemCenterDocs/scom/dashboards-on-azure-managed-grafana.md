...
1. Get started by using an Azure Managed Grafana (AMG) with minimum version of 10.2.0  on the Azure portal. To create an AMG instance, follow [these steps](https://learn.microsoft.com/azure/managed-grafana/quickstart-managed-grafana-portal). Optionally, you can reuse an existing AMG instance.
