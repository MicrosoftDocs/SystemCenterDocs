...
##### [How to configure web application availability monitoring](./gsm/how-to-configure-web-application-availability-monitor-signing-in-and-setup.md)
##### [How to configure Visual Studio web test monitoring](./gsm/how-to-configure-web-application-availability-monitoring-in-gsm.md)
#### [Monitoring Tests and Alerts for GSM](monitoring-tests-and-alerts-for-global-service-monitor.md)
...
#### [Terms and Conditions for GSM as a Software Assurance Benefit](./gsm/term-conditions-for-gsm-as-sa-benefit.md) 