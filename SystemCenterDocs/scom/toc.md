...
#### [Install agent on UNIX and Linux from command line - 2016](manage-install-crossplat-agent-cmdline-2016.md)
#### [Install agent on UNIX and Linux from command line - 1801](manage-install-crossplat-agent-cmdline-1801.md)
...
### [Using Global Service Monitor](./gsm/global-service-monitor.md)
#### [Getting Started](./gsm/getting-started-with-global-service-monitor-signing-in-and-setup.md)
#### [Configuring Tests](./gsm/configuring-tests-in-global-service-monitor.md)
##### [How to configure web application availability monitoring](./gsm/how-to-configure-web-application-availability-monitoring-in-gsm.md)
##### [How to configure Visual Studio web test monitoring](./gsm/how-to-configure-visual-studio-web-test-monitoring-in-global-service-monitor.md)
