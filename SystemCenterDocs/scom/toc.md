...
#### [How to Configure an HTTPS Binding for a Windows Server CA](how-to-obtain-certificate-windows-server-and-operations-manager.md)
#### [How to obtain a certificate for use with Windows Servers and System Center Operations Manager](how-to-obtain-certificate-windows-server-enterprise-ca.md)
