...
#### [Install agent on UNIX and Linux from command line](manage-install-crossplat-agent-cmdline-2016.md)
#### [Install agent on UNIX and Linux from command line](manage-install-crossplat-agent-cmdline-1801.md)
