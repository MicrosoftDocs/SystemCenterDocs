...
### [Changes History](asdmp-changes-history.md)
### [Management Pack Scope and Supported Configuration](asdmp-supported-configuration.md)
### [Management Pack Delivery](asdmp-management-pack-delivery.md)
### [Monitoring Configuration](asdmp-monitoring-configuration.md)
...
### [Known Issues and Troubleshooting](asdmp-known-issues-and-troubleshooting.md)
## Management Pack for Azure SQL Managed Instance
### [Changes History](mimp-changes-history.md)
### [Management Pack Scope and Supported Configuration](mimp-supported-configuration.md)
### [Management Pack Delivery](mimp-management-pack-delivery.md)
### [Monitoring Configuration](mimp-monitoring-configuration.md)
...
### [Known Issues and Troubleshooting](mimp-known-issues-and-troubleshooting.md)