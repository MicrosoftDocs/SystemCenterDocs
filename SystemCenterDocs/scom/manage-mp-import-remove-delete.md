...
> [!NOTE]  
> Using the Operations Console, you can only export unsealed management packs. To export a sealed management pack, you must use the Export-SCOMManagementPack cmdlet. See [Operations Manager Cmdlet Reference](/previous-versions/system-center/powershell/system-center-2012-r2/hh545244(v=sc.20)) for more information.  
