...
|The **Service State** monitor does not work on a clustered SQL Server Analysis Services node.|The **Service State** monitor does not work when the SQL Server Analysis Services server is used as a cluster node.|No resolution.|
