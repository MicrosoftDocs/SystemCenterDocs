...
4. Search for SCOM and register **Microsoft.Scom**.
      ...
      :::image type="Register resource provider" source="media/create-operations-manager-managed-instance/register-resource-provider.png" alt-text="Screenshot showing register resource provider page.":::
