...
5. In the Subscription page, under **Settings**, select **Resource providers** and search for **microsoft.insights**. If the **microsoft.insights** provider isn't registered, select the provider and then select **Register**. However, if the provider is registered, ignore rest of the steps.
