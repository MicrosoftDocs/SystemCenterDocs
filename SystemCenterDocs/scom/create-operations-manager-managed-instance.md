...
>- To perform operation on DNS server, you need to sign in to DNS server and run **DNS manager** tool.
...
2.	Select **Set admin**, search for your MSI (the same MSI that you provided during the SCOM Managed Instance (preview) creation flow). You'll find the admin added to the SQL MI.
...
1. Under **Basics**, do the following:
    ...
    1. **Domain account details**:
        ...
        1. **Password secret**: Enter the secret name for password under the selected key vault.
          ...
          :::image type="Domain account details" source="media/create-operations-manager-managed-instance/secret-password-mapping.png" alt-text="Screenshot showing Domain account details.":::
