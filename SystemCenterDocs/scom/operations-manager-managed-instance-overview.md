...
To know about the SCOM Managed Instance Architecture, see [Azure Monitor SCOM Managed Instance](operations-manager-managed-instance-overview.md#architecture).
