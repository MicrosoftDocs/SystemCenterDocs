...
To start monitoring a Nano Server, follow these steps:
...
If you encounter any difficulties with removing the Operations Manager Agent on a Nano Server, follow the checklist below for possible solutions.
