...
|**Run As account**|**Devices** page, **Add** button|The available accounts in the menu are populated based on your selection in the **SNMP version** box. You can create the appropriate Run As account by clicking **Add SNMP**_version_**Run As Account**.|
