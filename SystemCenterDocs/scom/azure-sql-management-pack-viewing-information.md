...
Management Pack for Azure SQL Database introduces a common folder structure described in [Views and Dashboards in Management Pack for SQL Server](sql-server-management-pack-views-and-dashboards.md).

The following figure shows an example of views that are available in Management Pack for Azure SQL Database.

![Screenshot showing Azure SQL Database views.](./media/azure-sql-management-pack/views.png)
