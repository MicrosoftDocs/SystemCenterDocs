...
|Alerts|-   To configure alert resolution states.<br>-   To configure automatic alert resolution.|-   [Set alert resolution states](manage-alert-set-resolution-states.md)<br>-   [Configure automatic alert resolution](manage-alert-configure-auto-resolution.md)|  
