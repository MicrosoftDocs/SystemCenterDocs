...
> - When creating or editing a maintenance schedule, you cannot include more than 216 Objects at a time, you may receive the following error message:
>  **The client has been disconnected from the server. Please call ManagementGroup.Reconnect() to reestablish the connection**
> - To include more than 216 objects create single or multiple [groups](manage-create-manage-groups.md) with all of the objects you would like to add to the  maintenance schedule, and  create a maintenance schedule targeting the group(s). No more than 216 group objects can be added at a time.
>
