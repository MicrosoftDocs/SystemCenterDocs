...
description: This article describes the information on handling monitor health status for alerts in System Center 2019 - Operations Manager
...
In earlier releases of System Center Operations Manager, an alert which is generated by a monitor cannot be closed unless the health state of the corresponding monitor is **healthy**. OM 2019 allows you to manually reset the health status of a monitor for an alert, by using the new **Alert Closure Failure** dashboard, and close the corresponding alert.  
...
2.	You can reset the health status of the monitor for the corresponding alert, in the following two ways:
