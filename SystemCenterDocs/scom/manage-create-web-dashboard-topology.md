...
For a topology diagram which includes monitored object health state in the widget, you can reposition the icons of the selected objects on the selected image.
