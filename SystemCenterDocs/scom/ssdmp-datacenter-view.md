...
![Datacenter view](./media/ssdmp/datacenter-view.png)
...
![Datacenter view tiles](./media/ssdmp/datacenter-view-tiles.png)

Expanded mode shows the number of objects in other states in addition to the data displayed in collapsed mode.

![Datacenter view ex[anded tiles]](media/ssdmp/datacenter-view-tiles-expanded.png)
...
![Datacenter view tile mode](./media/ssdmp/datacenter-view-tiles-expanded-alert-widgets.png)

The Aggregated state monitor tile provides the number of object selected classes per state.

![Aggregated state monitor](./media/ssdmp/datacenter-view-tiles-agregated-state-monitor.png)
...
![Aggregated performance tile](./media/ssdmp/datacenter-view-tiles-agregated-performance-tile.png)
