...
-  Review [Viewing Active Alerts and Details](../om/manage/viewing-active-alerts-and-alert-details.md) to understand how it can help you review alerts that have been generated by rules and monitors which are still active.  

-  To understand how Operations Manager monitors the communication channel between an agent and it's primary management server to ensure it is responsive and available, see [How Heartbeats Work in Operations Manager](../om/manage/how-heartbeats-work.md). 
