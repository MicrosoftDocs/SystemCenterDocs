...
|System Center Operations Manager issue: Configuration Service may be frozen after Management Pack reinstallation|Configuration Service may be frozen after Management Pack reinstallation.|No resolution.|
...
|Errors occur in the **HKTableMemoryUsageAction** workflow related to Memory-Optimized Data: "Memory Used By Indexes (MB)", "Memory Used By Tables (MB)"|Such errors may indicate that you have performance degradation in the environments with numerous Memory-Optimized databases|Investigate performance degradation on affected servers and solve it if possible.|
