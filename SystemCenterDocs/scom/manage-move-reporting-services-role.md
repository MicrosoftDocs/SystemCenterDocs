...
1. On the current Operations Manager reporting server, uninstall the Operations Manager reporting server component as follows:
    ...
    b. In **Programs and Features**, if the installation is System Center 2016 - Operations Manager select **System Center 2016 Operations Manager**, if the installation is current branch, select **System Center Operations Manager**.  

    c. Click **Uninstall**.  
   
    d. In the **Operations Manager Setup** wizard, click **Remove a feature**.  

    e. In the **Select features to remove** page, select **Reporting server**, and then click **Uninstall**. Click **Close** when the wizard finishes.  
