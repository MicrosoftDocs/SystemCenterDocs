...
5.  On the **Credentials** page, select one of the credentials options.
    ...
    For detailed instructions on how to set credentials, see [How to Set Credentials for Accessing UNIX and Linux Computers](../Topic/How-to-Set-Credentials-for-Accessing-UNIX-and-Linux-Computers.md).

6.  Click **Upgrade**.

## Uninstalling Agents
You can uninstall an agent from the targeted computer by using the **UNIX\/Linux Agent Uninstall Wizard**. For information on manually uninstalling agents, see [Manually Uninstalling Agents from UNIX and Linux Computers](../Topic/Manually-Uninstalling-Agents-from-UNIX-and-Linux-Computers.md).
