...
## Prerequisites
You must ensure that your server meets the minimum supported configurations for [!INCLUDE[scom_threshold_1](Token/scom_threshold_1_md.md)]. For more information, see [System Requirements for System Center Technical Preview](System-Requirements-for-System-Center-Technical-Preview.md).
