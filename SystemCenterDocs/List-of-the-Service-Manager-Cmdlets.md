...
|Cmdlet|Description|
|----------|---------------|
|Add\-SCSMAllowListClass|Adds the specified classes to the Allow list of classes that is used by the [!INCLUDE[smshort](./Token/smshort_md.md)] Operations Manager CI Connector during synchronization.|
|Export\-SCSMManagementPack|Exports a management pack as a valid XML\-formatted file that you can later import into [!INCLUDE[smshort](./Token/smshort_md.md)] or [!INCLUDE[om12short](./Token/om12short_md.md)].|
|Get\-SCSMAllowList|Retrieves the Allow list of classes that is used by the [!INCLUDE[smshort](./Token/smshort_md.md)] Operations Manager CI Connector during synchronization.|
|Get\-SCSMAnnouncement|Retrieves announcements that are defined in [!INCLUDE[smshort](./Token/smshort_md.md)].|
|Get\-SCSMChannel|Retrieves the Email Notification channels that are defined in [!INCLUDE[smshort](./Token/smshort_md.md)].|
|Get\-SCSMClass|Retrieves a class.|
|Get\-SCSMClassInstance|Retrieves class instance objects.|
|Get\-SCSMCommand||
|Get\-SCSMConnector|Retrieves connectors that are defined in [!INCLUDE[smshort](./Token/smshort_md.md)].|
|Get\-SCSMDCMWorkflow|Retrieves the list of desired configuration management workflows that are defined in [!INCLUDE[smshort](./Token/smshort_md.md)].|
|Get\-SCSMDeletedItem|Retrieves items that have been marked for deletion in [!INCLUDE[smshort](./Token/smshort_md.md)].|
|Get\-SCSMDiscovery|Retrieves discovery information from [!INCLUDE[om12short](./Token/om12short_md.md)] and from [!INCLUDE[smshort](./Token/smshort_md.md)].|
|Get\-SCSMEmailTemplate|Retrieves Email templates that are defined in [!INCLUDE[smshort](./Token/smshort_md.md)].|
|Get\-SCSMEmailTemplateContent|Retrieves the content of [!INCLUDE[smshort](./Token/smshort_md.md)] Email templates.|
|Get\-SCSMGroup|Retrieves groups from [!INCLUDE[om12short](./Token/om12short_md.md)] and from [!INCLUDE[smshort](./Token/smshort_md.md)].|
...
|Get\-SCSMPortalCMConfiguration|Retrieves the settings for the Configuration Manager that is used for software deployments on the [!INCLUDE[smshort](./Token/smshort_md.md)][!INCLUDE[smssp](./Token/smssp_md.md)].|
...
|Get\-SCSMQueue|Retrieves queues that are defined in [!INCLUDE[smshort](./Token/smshort_md.md)].|
|Get\-SCSMRelationship|Retrieves information about relationship objects from [!INCLUDE[om12short](./Token/om12short_md.md)] and from [!INCLUDE[smshort](./Token/smshort_md.md)].|
...
|Remove\-SCSMConnector|Removes a connector from [!INCLUDE[smshort](./Token/smshort_md.md)].|
