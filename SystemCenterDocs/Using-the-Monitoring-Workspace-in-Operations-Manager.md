...
There are number of views in the **Monitoring** workspace that allow you to view the status of your environment. For information on each view, see [Standard Views in Operations Manager](Standard-Views-in-Operations-Manager.md). You can change the display options of a view and save it as a personalized view. For more information, see [How to Personalize a View in Operations Manager](How-to-Personalize-a-View-in-Operations-Manager.md).
