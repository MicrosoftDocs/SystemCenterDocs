...
The Service Management Automation PowerShell module provides the Windows PowerShell cmdlets that are used to administer Service Management Automation. The Service Management Automation PowerShell module can be installed from the System Center 2012 R2 Orchestrator installation software.

#### To install the Service Management AutomationPowerShell module

1.  In the folder where you downloaded the System Center 2012 R2 Orchestrator installation software, start the Setup wizard.
