...
Requests to start a runbook are performed by the [!INCLUDE[sma_1](../../includes/sma_1_md.md)] web service using either the Service Management Portal or the [Start\-SmaRunbook](http://aka.ms/runbookauthor/startsmarunbook) Windows PowerShell cmdlet. The web service writes this request to the [!INCLUDE[sma_2](../../includes/sma_2_md.md)] database where it is retrieved by one of the [!INCLUDE[sma_2](../../includes/sma_2_md.md)] Worker servers. 
