...
Use the guidance in this section to scale out a machine tier in a service that is deployed in [!INCLUDE[sma_1](../../includes/sma_1_md.md)]. You can add runbook workers and web services to add additional capacity for runbook processing.
...
### Scale out [!INCLUDE[sma_1](../../includes/sma_1_md.md)]
