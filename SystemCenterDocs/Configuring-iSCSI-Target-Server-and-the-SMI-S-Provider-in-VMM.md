...
-   [Architecture design](../Topic/Configuring-iSCSI-Target-Server-and-the-SMI-S-Provider-in-VMM.md#BKMK_architecture)

-   [Known issues with the SMI-S provider](../Topic/Configuring-iSCSI-Target-Server-and-the-SMI-S-Provider-in-VMM.md#BKMK_known)

-   [Provider details](../Topic/Configuring-iSCSI-Target-Server-and-the-SMI-S-Provider-in-VMM.md#BKMK_provider)
...
-   [How to prepare an iSCSI Target Server to work with VMM](../Topic/How-to-prepare-an-iSCSI-Target-Server-to-work-with-VMM.md)

-   [How to configure an iSCSI Target Server with Windows PowerShell and VMM](../Topic/How-to-configure-an-iSCSI-Target-Server-with-Windows-PowerShell-and-VMM.md)
