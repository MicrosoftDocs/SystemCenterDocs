...
|--------------|--------------------------------|  
|**File**|Select and enter the name of the log file that'll be read. You can also use the ellipsis **(...)** button to browse for the file.|  
|**The most recent file in this folder**|Select and enter the folder where the most recent file that matches the pattern that you specify will be read. You can also use the ellipsis **(...)** button to browse for the folder.|  
