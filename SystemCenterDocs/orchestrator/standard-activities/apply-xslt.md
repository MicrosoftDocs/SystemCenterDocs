...
|--------------|--------------------------------|  
|**Input XML file**|Type the path and file name of the XML file that you want to transform, or select the ellipsis button **(...)** and browse for it.|  
|**Output XML file**|Type the path, file name, and file name extension for the file that will hold the results of the transformation. Alternatively, select the ellipsis button **(...)** and browse for the folder where you'll save the file. From the Windows **Open** dialog box, enter the file name and file name extension in the **File name** box.|  
|**XSLT file**|Type the path and name of the XSLT file that you want to use to transform the input XML file, or select the ellipsis button **(...)** and browse for it.|  
