...
-   Create an ODBC DSN on the Runbook Server that connects to the HP Service Manager database. Make sure this DSN information is added to the connection information for that HP Service Manager system. For more information about creating connections to HP Service Manager, see [Configuring the HP Service Manager Connections](https://technet.microsoft.com/library/4b9fedf9-e89a-4298-bf57-79c5d4ccdd6b#ConfiguringConnections).
