...
By default, the Audit Trail isn't activated when you install Orchestrator. You can use the following procedure to activate it.  
...
3.  To activate the Audit Trail, enter **atlc \/enable**, and to deactivate the Audit Trail, enter **atlc \/disable**.  
