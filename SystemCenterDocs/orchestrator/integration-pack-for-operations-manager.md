...
- Operations Manager. The integration pack version should match the System Center version.
    ...
    >[!NOTE]
    >If you're using the Orchestrator 2016 or 1801 integration pack for Operations Manager 2016 UR4 or later, if you've configured Operations Manager to accept only TLS 1.1 or 1.2 connections, make the registry changes [detailed here](#enable-sco-ip-for-operations-manager-2016-ur4-and-later).
