---
title: System Center 2016 Data Protection Manager Activities
description: The following configuration instructions apply to all activities in the System Center Integration Pack for System Center 2016 Data Protection Manager.
ms.custom: na
ms.date: 12/02/2016
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 4f8759a9-ce9f-48b6-ab60-56328ae0781a
author: cfreemanwa
ms.author: cfreeman
manager: carmonm
robots: noindex
...
This tab contains properties that are specific to the activity. All activities in this integration pack have the **Configuration Name** property at the top of the **Properties** or **Filters** tab. This property is used to specify the connection to the DPM server.

#### To configure the Configuration Name property

1.  Click the ellipsis **(...)** button next to the **Name** field.

2.  Select the applicable connection name. Connections displayed in the list have been previously configured as described in [Configuring the System Center 2016 Data Protection Manager Connections](https://technet.microsoft.com/en-us/library/cf999026-3dc0-48cf-9396-fa92a1b40c63#BKMK_SettingUpDPMConnect).
