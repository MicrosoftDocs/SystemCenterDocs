...
-   *Common Published Data*  
    ...
    The set of data items common to all activities. For a list, see the [Runbook Log Options](design-and-build-runbooks.md) section in [runbook logs](../orch/get-started/runbook-logs.md).  
