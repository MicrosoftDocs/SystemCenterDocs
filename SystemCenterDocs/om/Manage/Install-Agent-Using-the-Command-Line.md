...
You can use MOMAgent.msi to deploy [!INCLUDE[om12long](../../includes/om12long_md.md)] agents from the command line. Deploying agents from the command line is also referred to as a manual install.
