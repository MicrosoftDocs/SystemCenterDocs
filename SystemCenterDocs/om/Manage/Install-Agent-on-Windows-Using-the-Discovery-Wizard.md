...
When agents are pushed out to computers, [!INCLUDE[om12long](../../includes/om12long_md.md)] sends credentials that have local administrator rights for that computer; this is required to install the agent.
