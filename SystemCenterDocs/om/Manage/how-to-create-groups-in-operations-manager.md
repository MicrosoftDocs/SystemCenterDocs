...
You can use groups in System Center 2016 - Operations Manager to scope views, reports, overrides, and alert notifications. You create groups in the **Authoring** workspace in the Operations console.  
