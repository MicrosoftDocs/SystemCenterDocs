...
Review [Connecting Operations Manager With Other Management Systems](connecting-operations-manager-with-other-management-systems.md) to learn how to integrate Operations Manager with another monitoring platform or ITSM system using a product connector developed using the Operations Manager SDK.  
