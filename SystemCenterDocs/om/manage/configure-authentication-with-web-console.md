...
- To configure FIPS compliance for the Reporting server, see [Configure Authentication for Reporting server](../../scom/configure-authentication-with-reporting-server.md) 
