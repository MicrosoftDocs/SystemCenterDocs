...
![Filter alerts by severity](../media/om2016-web-console-alertview-filter.png)  
...
![Active Alerts](../media/om2016-view-active-alerts.png)  
...
- Review [How to Close an Alert Generated by a Monitor](how-to-close-an-alert-generated-by-a-monitor.md) to understand the behavior of alerts generated by monitors and how to approach managing alerts from them.  
