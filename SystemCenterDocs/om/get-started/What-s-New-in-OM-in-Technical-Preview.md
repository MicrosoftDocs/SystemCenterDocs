...
With the release of System Center 2016 Technical Preview 5 ‚Ä" Operations Manager, you get better visibility of the alerts being generated in your management group which helps you reduce alerts that you don't consider actionable or relevant.   
...
In the System Center 2016 Technical Preview 5 ‚Ä" Operations Manager release, we have included the following changes to monitor Nano Server:
...
With the release of System Center 2016 Technical Preview 5 ‚Ä" Operations Manager, we have made performance improvements to alert views in the Operations console to increase responsiveness.
...
The ‚ÄúMaintenance Schedules‚Äù feature offers the following advantages over the ‚ÄúMaintenance Mode‚Äù Task.
