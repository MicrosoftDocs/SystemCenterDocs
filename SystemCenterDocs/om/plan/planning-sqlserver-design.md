...
See also [Operations Manager virtualization support](system-requirements.md#virtualization) for additional guidance on virtualized Operations Manager environment.  
