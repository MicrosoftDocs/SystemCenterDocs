...
In [!INCLUDE[sma_1](../../includes/sma_1_md.md)], database purging is automatic, but you can adjust it to your needs.
...
The database purge job is automatic, but it can be regulated by the [!INCLUDE[sma_1](../../includes/sma_1_md.md)] administrator.
