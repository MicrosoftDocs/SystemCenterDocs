...
---
# Editing a Runbook
Each runbook in [!INCLUDE[sma_1](../../includes/sma_1_md.md)] has two versions, Draft and Published. You edit the Draft version of the workflow and then publish it so it can be executed. The Published version cannot be edited.
