...
## Overview
[!INCLUDE[smalong](../includes/smalong_md.md)] is an IT process automation solution for [!INCLUDE[katal_1](../includes/katal_1_md.md)]. It enables you to automate the creation, monitoring, and deployment of resources in your [!INCLUDE[katal_2](../includes/katal_2_md.md)] environment.
...
## [!INCLUDE[smalong](../includes/smalong_md.md)] topics

-   [Overview of Service Management Automation](get-started/Overview-of-Service-Management-Automation.md)

    Provides a brief overview of the purpose and capabilities of [!INCLUDE[smalong](../includes/smalong_md.md)].

-   [Architecture of Service Management Automation](get-started/Architecture-of-Service-Management-Automation.md)

    Describes the architecture of a basic [!INCLUDE[smalong](../includes/smalong_md.md)] deployment.

-   [Deploy Service Management Automation](Deploy/Deploy-Service-Management-Automation.md)

    Provides a brief overview of the steps to deploy [!INCLUDE[smalong](../includes/smalong_md.md)].
