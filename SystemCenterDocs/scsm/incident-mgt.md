...
4.  In the New Accepted Domain Wizard, on the **New Accepted Domain** page, in the **Name** box, enter a descriptive name. For example, type **From SMTP Server**, and in **Accepted Domain**, type the SMTP domain name that you created for Service Manager. For example, enter **\*.Servername.domain.com**.
