...
To customize management packs that are bundled in a .mpb file, you must first unbundle the .mpb file and then individually customize each management pack and resource file. For more information about how to unbundle a .mpb management pack file, see [How to Unbundle a Bundled management pack](unbundle-mps.md).  
