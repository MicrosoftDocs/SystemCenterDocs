...
When agents are pushed out to computers, [!INCLUDE[scom_threshold_1](../../includes/scom_threshold_1_md.md)] sends credentials that have local administrator rights for that computer; this is required to install the agent.
