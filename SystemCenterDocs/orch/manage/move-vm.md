...
| Last Restored VM Checkpoint   | The name of the most recently restored VM Checkpoint   |   |
...
| Source Object Type   | The type of the source object that was used to create the virtual machine; for example, VM, Template, or VHD   |   |
