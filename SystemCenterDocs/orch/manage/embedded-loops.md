...
5.  To change the different parts of the expression, select the underlined text and either select or type in an appropriate value. For more information about criteria, see [Smart Link Criteria](http://technet.microsoft.com/en-us/library/hh403779.aspx).  
