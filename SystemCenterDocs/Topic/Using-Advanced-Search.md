...
-   [Select the specific object type and criteria](../Topic/Using-Advanced-Search.md#BKMK_Selectthespecificobjecttype)

-   [Set the criteria values](../Topic/Using-Advanced-Search.md#BKMK_Setthecriteriaandvalues)

You can also save the searches you create. For more information, see [Running and saving searches](../Topic/Using-Advanced-Search.md#bkmk_runningandsavingsearches).
...
[Examples of Using Advanced Search in Operations Manager](../Topic/Examples-of-Using-Advanced-Search-in-Operations-Manager.md)
