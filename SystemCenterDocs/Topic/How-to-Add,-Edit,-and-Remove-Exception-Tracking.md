...
The default list of .NET functions that are monitored for exceptions includes namespaces and functions, some of which have monitoring disabled by default. For more information, see [Using Exception Handlers to Define Critical Exceptions](../Topic/Using-Exception-Handlers-to-Define-Critical-Exceptions.md), which includes a list of default exception handlers.
