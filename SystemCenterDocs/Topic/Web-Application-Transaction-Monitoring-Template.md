...
The HTTP requests are sent from one or more [Watcher Nodes](../Topic/Watcher-Nodes.md). The website that is being monitored can reside on any computer whether it has an agent for [!INCLUDE[om12short](../Token/om12short_md.md)] installed. It can be an external website, but it must be accessible from the watcher nodes. Each watcher node must have an [!INCLUDE[om12short](../Token/om12short_md.md)] agent installed.
...
-   [How to Create a Single URL Web Application Monitor](../Topic/How-to-Create-a-Single-URL-Web-Application-Monitor.md)
...
-   [How to Replace Parameters in a URL Request](../Topic/How-to-Replace-Parameters-in-a-URL-Request.md)
