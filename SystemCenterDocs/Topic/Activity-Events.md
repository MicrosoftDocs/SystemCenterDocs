...
---
# Activity Events
Each activity in an [!INCLUDE[orchshort](../Token/orchshort_md.md)] runbook has the ability to send an event whenever it fails to run or is taking too long to run. These events are presented on the **Events** tab of the Runbook Designer or can be configured to be delivered to a receiver as an SNMP trap. Runbook activity events are only sent for those activities that you specifically configure to do so.
...
In addition to viewing the events on the **Events** tab in the Runbook Designer, you can send them to an SNMP trap destination. This lets you monitor the health of the [!INCLUDE[orchshort](../Token/orchshort_md.md)] environment by using other tools designed to provide proactive alerting. The only requirement for such a tool is that it can receive SNMP traps. You can use the **[!INCLUDE[orchshort](../Token/orchshort_md.md)] Event Delivery Configuration Utility** to add and configure SNMP trap destinations for Runbook events.
...
4.  Restart the [!INCLUDE[orchshort](../Token/orchshort_md.md)] Runbook Service and the [!INCLUDE[orchshort](../Token/orchshort_md.md)] Runbook Server Monitor service.
...
|Generic ID|\(6\)|
|Specific ID|\(1\)|
|[!INCLUDE[orchshort](../Token/orchshort_md.md)] Event Information IDs|[!INCLUDE[orchshort](../Token/orchshort_md.md)] Event Type – 1<br /><br />[!INCLUDE[orchshort](../Token/orchshort_md.md)] Event Summary – 2<br /><br />[!INCLUDE[orchshort](../Token/orchshort_md.md)] Event Details – 3|
|Example|[!INCLUDE[orchshort](../Token/orchshort_md.md)] Event Type – 1.3.6.1.4.1.4217.100.100.1<br /><br />[!INCLUDE[orchshort](../Token/orchshort_md.md)] Event Summary – 1.3.6.1.4.1.4217.100.100.2<br /><br />[!INCLUDE[orchshort](../Token/orchshort_md.md)] Event Details – 1.3.6.1.4.1.4217.100.100.3|
