---
title: List of the Service Manager Cmdlets_2
ms.custom: na
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 9ed5480a-7e45-4c0b-8750-48aa42018572
---
# List of the Service Manager Cmdlets_2
[!INCLUDE[scsm_threshold_1](../Token/scsm_threshold_1_md.md)] supports the following Windows PowerShell cmdlets, which are implemented in two modules: the administrator module and the data warehouse module.

## Administrator Cmdlets in the System.Center.Service.Manager Module

|Cmdlet|Description|
|----------|---------------|
|Add\-SCSMAllowListClass|Adds the specified classes to the Allow list of classes that is used by the [!INCLUDE[smshort12](../Token/smshort12_md.md)] Operations Manager CI Connector during synchronization.|
|Export\-SCSMManagementPack|Exports a management pack as a valid XML\-formatted file that you can later import into [!INCLUDE[smshort12](../Token/smshort12_md.md)] or [!INCLUDE[om12short](../Token/om12short_md.md)].|
|Get\-SCSMAllowList|Retrieves the Allow list of classes that is used by the [!INCLUDE[smshort12](../Token/smshort12_md.md)] Operations Manager CI Connector during synchronization.|
|Get\-SCSMAnnouncement|Retrieves announcements that are defined in [!INCLUDE[smshort12](../Token/smshort12_md.md)].|
|Get\-SCSMChannel|Retrieves the Email Notification channels that are defined in [!INCLUDE[smshort12](../Token/smshort12_md.md)].|
|Get\-SCSMClass|Retrieves a class.|
|Get\-SCSMClassInstance|Retrieves class instance objects.|
|Get\-SCSMCommand||
|Get\-SCSMConnector|Retrieves connectors that are defined in [!INCLUDE[smshort12](../Token/smshort12_md.md)].|
|Get\-SCSMDCMWorkflow|Retrieves the list of desired configuration management workflows that are defined in [!INCLUDE[smshort12](../Token/smshort12_md.md)].|
|Get\-SCSMDeletedItem|Retrieves items that have been marked for deletion in [!INCLUDE[smshort12](../Token/smshort12_md.md)].|
|Get\-SCSMDiscovery|Retrieves discovery information from [!INCLUDE[om12short](../Token/om12short_md.md)] and from [!INCLUDE[smshort12](../Token/smshort12_md.md)].|
|Get\-SCSMEmailTemplate|Retrieves Email templates that are defined in [!INCLUDE[smshort12](../Token/smshort12_md.md)].|
|Get\-SCSMEmailTemplateContent|Retrieves the content of [!INCLUDE[smshort12](../Token/smshort12_md.md)] Email templates.|
|Get\-SCSMGroup|Retrieves groups from [!INCLUDE[om12short](../Token/om12short_md.md)] and from [!INCLUDE[smshort12](../Token/smshort12_md.md)].|
...
|Get\-SCSMPortalCMConfiguration|Retrieves the settings for the Configuration Manager that is used for software deployments on the [!INCLUDE[smshort12](../Token/smshort12_md.md)][!INCLUDE[smssp](../Token/smssp_md.md)].|
|Get\-SCSMPortalContactConfiguration|Retrieves the IT Contact setting that the  [!INCLUDE[smssplong](../Token/smssplong_md.md)] is configured with.|
|Get\-SCSMPortalDeploymentProcess|Retrieves information about software deployment processes for the [!INCLUDE[smssplong](../Token/smssplong_md.md)].|
|Get\-SCSMPortalSoftwarePackage|Retrieves all the software packages that are configured for deployment in the [!INCLUDE[smssplong](../Token/smssplong_md.md)].|
|Get\-SCSMQueue|Retrieves queues that are defined in [!INCLUDE[smshort12](../Token/smshort12_md.md)].|
|Get\-SCSMRelationship|Retrieves information about relationship objects from [!INCLUDE[om12short](../Token/om12short_md.md)] and from [!INCLUDE[smshort12](../Token/smshort12_md.md)].|
|Get\-SCSMRelationshipInstance|Retrieves the instances of relationships from [!INCLUDE[om12short](../Token/om12short_md.md)] and from [!INCLUDE[smshort12](../Token/smshort12_md.md)].|
...
|Remove\-SCSMDCMWorkflow|Removes a desired configuration management workflow from [!INCLUDE[smshort12](../Token/smshort12_md.md)].|
...
## See Also
[Configuring and Using the System Center Technical Preview - Service Manager Cmdlets for Windows PowerShell](../Topic/Configuring-and-Using-the-System-Center-Technical-Preview---Service-Manager-Cmdlets-for-Windows-PowerShell.md)
