...
|Description of how to add file\-based resources, such as virtual hard disk files, to the [!INCLUDE[vmm12short](../Token/vmm12short_md.md)] library|[How to add file-based resources to the VMM library](../Topic/How-to-add-file-based-resources-to-the-VMM-library.md) on TechNet|
