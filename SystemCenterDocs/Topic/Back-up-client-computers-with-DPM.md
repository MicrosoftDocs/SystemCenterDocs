...
-   Read about the client operating systems you can support in [What can DPM back up?](../Topic/What-can-DPM-back-up-.md)

-   Review the [release notes](http://technet.microsoft.com/en-us/library/jj860394.aspx) and read about any client protection issues in [What's supported and what isn't for DPM?](../Topic/What-s-supported-and-what-isn-t-for-DPM-.md)
...
2.  **Set up storage**—
    You can store backed up data on disk, on tape, and in the cloud with Azure.
      Read more in [Prepare data storage](../Topic/Prepare-data-storage.md).

3.  **Set up the DPM protection agent**—The agent needs to be installed on client computers you want to protect.  Read [Deploy the DPM protection agent](../Topic/Deploy-the-DPM-protection-agent.md).
