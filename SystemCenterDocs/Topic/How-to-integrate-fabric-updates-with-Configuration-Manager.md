...
1.  Add the WSUS server to [!INCLUDE[vmm12short](../Token/vmm12short_md.md)] by following the steps in [How to add an update server to VMM](../Topic/How-to-add-an-update-server-to-VMM.md).
...
For more information about configuring update management, see [Managing fabric updates in VMM](../Topic/Managing-fabric-updates-in-VMM.md).
