...
-   [View and Analyze an OLAP Data Cube with Excel](../Topic/View-and-Analyze-an-OLAP-Data-Cube-with-Excel.md)
...
-   Review the list of OLAP data cubes present in [!INCLUDE[smshort](../Token/smshort_md.md)].
