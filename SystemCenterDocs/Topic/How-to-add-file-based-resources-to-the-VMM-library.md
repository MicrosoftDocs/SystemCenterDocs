...
[How to add a VMM library server or VMM library share](../Topic/How-to-add-a-VMM-library-server-or-VMM-library-share.md)
[Configuring the VMM library](../Topic/Configuring-the-VMM-library.md)
