...
Before you enable SSAS, you need to connect to an [!INCLUDE[om12short](../Token/om12short_md.md)] management server, as described in [How to connect VMM to Operations Manager](../Topic/How-to-connect-VMM-to-Operations-Manager.md).
