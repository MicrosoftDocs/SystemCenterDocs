...
Use the following steps to install the [!INCLUDE[orchlong](../Token/orchlong_md.md)] web service.

### To install the [!INCLUDE[orchshort](../Token/orchshort_md.md)] web service

1.  On the server where you want to install the [!INCLUDE[orchshort](../Token/orchshort_md.md)] web service, start the **[!INCLUDE[orchlong](../Token/orchlong_md.md)] Setup Wizard**.
...
2.  On the main **[!INCLUDE[orchlong](../Token/orchlong_md.md)] Setup Wizard** page, click **Install**.
