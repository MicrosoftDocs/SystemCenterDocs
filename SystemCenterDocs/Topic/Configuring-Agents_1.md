---
title: Configuring Agents_1
ms.custom: na
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: c45b0cc1-17b9-4107-920e-d85fb4cc6da5
---
# Configuring Agents_1
In [!INCLUDE[om12long](../Token/om12long_md.md)], when you install an agent on a computer, an Operations Manager Agent application is added to Control Panel. You can use the application to change the account that the agent will use when performing actions requested by the management server, to remove a management group from an agent configuration, and to configure the Active Directory integration setting for the agent. To perform these tasks, you must have local Administrator permissions on the computer.
...
-   [Configuring an Agent to Report to Multiple Management Groups](../Topic/Configuring-Agents.md#bkmk_configuringanagenttoreporttomultiplemanagementgorups)

-   [Changing the Account Configuration for an Agent](../Topic/Configuring-Agents.md#bkmk_ChangingtheAccountConfigurationforanAgent)

-   [Removing a Management Group from an Agent](../Topic/Configuring-Agents.md#bkmk_RemovingaManagementGroupfromanAgent)

-   [Changing the Active Directory Integration Setting for an Agent](../Topic/Configuring-Agents.md#bkmk_ChangingtheActiveDirectoryIntegrationSettingforanAgent)
