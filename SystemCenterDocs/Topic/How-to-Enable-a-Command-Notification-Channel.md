...
-   Create a notification subscriber that has the command channel selected in the subscriber address. For more information, see [How to Create Notification Subscribers](../Topic/How-to-Create-Notification-Subscribers.md).

-   Create a new subscription and select only the subscriber created for this command. For more information, see [How to Create Notification Subscriptions](../Topic/How-to-Create-Notification-Subscriptions.md).
