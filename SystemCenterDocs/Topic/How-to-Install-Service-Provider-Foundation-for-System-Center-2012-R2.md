...
1.  On the server where you want to install [!INCLUDE[spfshort](../Token/spfshort_md.md)], double\-click **SetupOrchestrator.exe** on the installation media to start the [!INCLUDE[orchlong](../Token/orchlong_md.md)] 2012 R2 Setup Wizard.
