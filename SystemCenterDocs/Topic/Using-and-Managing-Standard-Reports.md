...
-   Schedule a standard [!INCLUDE[smshort](../Token/smshort_md.md)] report.

-   Add reports to the report catalog that were not created in [!INCLUDE[smshort](../Token/smshort_md.md)].

-   Review the [Standard Reports Available in Service Manager](../Topic/Standard-Reports-Available-in-Service-Manager.md)
