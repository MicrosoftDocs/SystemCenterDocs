...
You must ensure that your server meets the minimum system requirement for [!INCLUDE[om12short](../Token/om12short_md.md)]. For more information, see [System Requirements for System Center Technical Preview](../Topic/System-Requirements-for-System-Center-Technical-Preview.md).
