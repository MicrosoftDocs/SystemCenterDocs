...
> [!NOTE]
> Before beginning this procedure, review [Prerequisites: creating a Scale-Out File Server in VMM from existing servers](../Topic/Prerequisites--creating-a-Scale-Out-File-Server-in-VMM-from-existing-servers.md)
