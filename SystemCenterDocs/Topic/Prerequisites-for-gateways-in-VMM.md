...
> [!TIP]
> [!INCLUDE[vmm12short](../Token/vmm12short_md.md)] in [!INCLUDE[sc_threshold_1](../Token/sc_threshold_1_md.md)] considers  a gateway to be a "network service," and the gateway requires additional configuration steps, as described in [How to add a non-Windows gateway in VMM](../Topic/How-to-add-a-non-Windows-gateway-in-VMM.md) or [How to add a Windows Server Gateway in VMM](../Topic/How-to-add-a-Windows-Server-Gateway-in-VMM.md).
