...
You can use the following procedure to install a highly available [!INCLUDE[vmm12sp1_long](../Token/vmm12sp1_long_md.md)] management server on an additional node of a failover cluster. For installing on the first node of a cluster, see [How to Install a Highly Available VMM Management Server](../Topic/How-to-Install-a-Highly-Available-VMM-Management-Server.md).
