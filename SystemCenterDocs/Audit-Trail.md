...
By default, the Audit Trail is not activated when you install [!INCLUDE[orchshort](Token/orchshort_md.md)]. You can use the following procedure to activate it.
