...
For more information and installing and customizing the portal, see [Deploy the Self-Service Portal for Service Manager](../Topic/Deploy-the-Self-Service-Portal-for-Service-Manager.md).
...
Disabled ECL logging is not automatically turned on. In other words, by default, ECL logging is enabled. However, you can easily turn on Disabled ECL logging by revising a registry key value. For more information, see [Optionally Disable ECL Logging for Faster Connector Synchronization](../Topic/Optionally-Disable-ECL-Logging-for-Faster-Connector-Synchronization.md).
