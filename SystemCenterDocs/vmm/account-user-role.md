...
::: moniker range="sc-vmm-2019"
    - **Administrator role**: Administrators can create the role. Delegated Administrators can create VM Administrator roles that include a subset of their scope, library servers, and Run As accounts.
::: moniker-end    
