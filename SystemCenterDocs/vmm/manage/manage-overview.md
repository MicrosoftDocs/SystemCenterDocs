...
## Manage the VMM networking fabric
 ...
 - **Manage logical networks**: You create logical networks that map to, and represent, your physical networks. You assign logical network settings that match the mapped physical network, including the network type, the associated network sites, and [static address pools](manage-network-static-address-pools.md) if relevant. [Get started](../network-logical.md).
