...
In order to manage storage you need to add and discover in the System Center 2016 - Virtual Machine Manager (VMM) storage fabric.
...
3.  In **Specify Discovery Scope**:
	...
	- If you're using SMI-S, specify whether the provider uses **SMI-S CIMXML** or **SMI-S WMI WMI**, and add the IP address/FQDN and port used to connect to the provider on the remote server. You can enable SSL if you're using CIMXML. Then specify an account for connecting to the provider
