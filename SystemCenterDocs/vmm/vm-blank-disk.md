...
After you create the virtual machine, you can [install an operating system](vm-install-operating-system.md) from an .iso image, from a CD or DVD or from a network boot if a Pre-Boot Execution Environment (PXE) server is available.
