...
- **Azure management**: Onboard to Azure Arc-enabled SCVMM to manage your VMs in a self-service fashion using Azure Role-Based Access Control and build automation and self-service pipelines using Terraform and Bicep templates, Azure REST APIs, Azure CLI, Azure PowerShell, and Python, Java, JavaScript, Go and .NET SDKs. Azure Arc-enabled SCVMM also unlocks Azure management services like Microsoft Defender for Cloud, Azure Monitor, Azure Update Manager, and Azure Policy enabling you to secure, govern, and manage your SCVMM VMs from the cloud.
::: moniker-end
## Resources
