...
-   To store virtual hard disks in the .vhdx file format, the [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)] library server must run Windows Server 2012, [!INCLUDE[winblue_server_2](../../includes/winblue_server_2_md.md)], or [!INCLUDE[winthreshold_server_2](../../includes/winthreshold_server_2_md.md)].
...
|Virtual machine hosts and host clusters that run any of the following versions of VMware:<br /><br />-   VMware ESXi 5.8<br />-   VMware ESXi 5.5<br />-   VMware ESXi 5.1|The host or host clusters must be managed by a vCenter Server, which is managed by [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)].|
...
You can use [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)] to find physical computers on the network, automatically install the Windows operating system on these computers, and then convert them into any of the following:
...
## Update management
In [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)] you can use a Windows Server Update Services \(WSUS\) server to manage updates for the following computers in your [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)] environment:
