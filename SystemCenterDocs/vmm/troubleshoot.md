...
VMM Configuration Analyzer (VMMCA) in [VMM Component Add-ons and Extensions](https://www.microsoft.com/download/details.aspx?id=29309) on the Microsoft Download Center | A diagnostic tool that you can use to evaluate important post-installation configuration settings for computers that either might serve or are serving VMM roles or other VMM functions.
