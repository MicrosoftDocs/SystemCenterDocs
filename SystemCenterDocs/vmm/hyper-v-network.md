...
To do this you'll need to [configure the logical switch](manage/manage-network-logical-switches.md) and [port profiles](manage/manage-network-port-profiles.md) you'll apply. Then you need to indicate what the physical network adapter is used for, and configure network settings by applying a logical switch. The network adapters that you configure can be physical or virtual adapters on the hosts.
