---
description:  Read about all the new capabilities in System Center 2016 - VMM
manager:  cfreemanwa
ms.topic:  article
...
This topic describes what's new and changed in Virtual Machine Manager (VMM) in System Center 2016. The topic includes the following sections:
...
- You can deploy and configure a Software Load Balancer to distribute traffic within a network managed by Network Controller. With this VMM 2016 release, Software Load Balancer can now also be used for in bound and out bound NAT.
