...
### [Configure fallback HGS settings](guarded-fallback-hgs.md)
### [Deploy a shielded VHDX and VM template](guarded-deploy-template.md)
### [Deploy a shielded VM](guarded-deploy-vm.md)
...
### [Set up a VM network in SDN](sdn-create-network.md)
### [Encrypt VM networks in SDN](sdn-encrypt-networks.md)
...
### [Update the NC server certificate](sdn-update-nc-server-certificate.md)
### [Set up SDN SLB VIPs](sdn-configure-slb-vip.md)
...
# How To
## Plan
### [System requirements - VMM](system-requirements.md)
...
### [Set up logical switches in VMM 1807](network-switch-1807.md)
