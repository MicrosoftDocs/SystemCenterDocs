...
Starting with [System Center 2025](/system-center/vmm/whats-new-in-vmm?view=sc-vmm-2025#support-for-azure-local-instances-23h2&preserve-view=true), VMM supports management of Azure Local Virtual Machines that are running on hosts with Azure Stack HCI, version 23H2 OS (OS version 25398.xxxx). VMM 2025 Update Rollup 1 adds support for Azure Local Virtual Machines that are running on hosts with Azure Stack HCI, version 24H2 OS (OS version 26100.xxxx). [Learn more](https://aka.ms/AzureStackHCI) about the new Azure Local offering.
