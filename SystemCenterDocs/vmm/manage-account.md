...
This article describes how to manage roles and permissions in System Center 2016 - Virtual Machine Manager (VMM). VMM provides:
...
- [Set up user roles](manage/manage-permissions-user-roles.md)
