...
To add a load balancer, follow these steps:
...
### [Create VIP templates](#tab/create-vip-templates)
...
5. In **Protocol**, select the protocol for which you want to create the VIP template:
	...
	- Select **HTTPS**, you'll need to specify where the traffic terminates.
...
### [Set up a hardware load balancer](#tab/set-up-a-hardware-load-balancer)
...
### [Enable load balancing](#tab/enable-load-balancing)
...
### [Set up the hardware VIP for user access](#tab/set-up-the-hardware-vip-for-user-access)
