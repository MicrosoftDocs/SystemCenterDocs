...
- [Set up a hardware load balancer](network-nlb.md#set-up-a-hardware-load-balancer): If you want to enable hardware load balancing in a service template there's a number of prerequisites you'll need to prepare.
