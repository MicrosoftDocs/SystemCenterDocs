...
8. [Set up a certificate](sdn-network-controller.md#set-up-certificates). You need an SSL certificate for HTTPS communications between VMM and the network controller.
