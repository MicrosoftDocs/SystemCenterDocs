...
**Note:** After you create a VM network with network virtualization, ensure you [create IP Pool](../manage/manage-network-static-address-pools.md#set-up-an-ip-address-pool-on-a-vm-network) for this VM network.
