...
Before you start setting QoS, you can verify the status of currently defined QoS policies for a SOFS cluster by running the Get-StorageQoSPolicy PowerShell cmdlet on a cluster node.
