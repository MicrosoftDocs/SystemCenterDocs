...
In [!INCLUDE[vmm12sp1_long](../../includes/vmm12sp1_long_md.md)], you can use physical computer profiles to provision bare\-metal computers into Hyper\-V hosts or host cluster nodes.
