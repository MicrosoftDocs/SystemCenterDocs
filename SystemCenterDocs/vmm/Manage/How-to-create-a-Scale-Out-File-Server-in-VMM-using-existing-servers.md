...
You can use [!INCLUDE[vmm12sp1_long](../../includes/vmm12sp1_long_md.md)] to  create a Scale\-Out File Server from existing Windows servers. .
...
5.  On the **Summary** page, confirm the settings, and then click **Finish** to create the cluster and to bring it under [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)] management.
