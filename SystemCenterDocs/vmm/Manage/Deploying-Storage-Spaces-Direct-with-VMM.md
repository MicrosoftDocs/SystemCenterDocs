...
![Hyper-Converged Stack](../../media/Hyper-Converged-Stack.png)
...
With VMM, we have integrated enabling the Storage Spaces Direct capability as part of the Create Hyper-V Cluster wizard. The first step in enabling Storage Spaces Direct is to run Create a Hyper-V cluster Wizard as shown in Figure 2.
 ...
 ![Enable Storage Spaces Direct screen](../../media/Enable-Storage-Spaces-Direct-screen.png)
...
![Create storage spaces direct cluster](../../media/Create-storage-spaces-direct-cluster.png)
...
![Cluster Resource Screen](../../media/Cluster-Resource-Screen.png)
...
1.  Add the host cluster as follows:
  1. On the **VMs and Services** Tab, right click **All Hosts** and select **Add Hyper-V Hosts and Clusters**.
  2. If the cluster is in some other domain, select the Windows server computer in untrusted Active Directory domain.
  3. Provide the RunAsAccount and the cluster name (see Figure 5) and proceed.

     ![Select Existing Cluster for VMM Management](../../media/VMM_S2D_OOBSelectCluster.png)

     **Figure 5: Adding an existing Storage Spaces Direct Cluster under VMM Management**

     4. This adds the Host cluster into VMM.
Once that is added, the Storage Provider for Spaces Direct needs to be added.

2.  Add the Storage Provider as follows:
  1. On **Fabric** Tab, Select **Add Resources** (Ribbon Button) -> **Storage Devices** (see Figure 6).

      ![Launch the Add Resource Wizard](../../media/VMM_S2D_AddResourceWizardLaunch.png)

      **Figure 6: Launching the Add Resource Wizard to add the Storage Provider**

  2. Select **Windows-based File Server**
  3. Provide RunAsAccount and Cluster name and check the checkbox if the cluster is in other domain and proceed.
  4. This adds Storage Provider into VMM.
...
![VMM Storage Cluster Diagram](../../media/VMM-Storage-Cluster-Diagram.png)
...
![Select Disks for Storage Pool](../../media/VMM_S2D_SelectPoolDisks.png)
...
![Storage Type Screen](../../media/Storage-Type-Screen.png)
...
![VMM Storage Capacity Screen](../../media/VMM-Storage-Capacity-Screen.png)
