...
You can use the following procedures to modify or delete a logical network in [!INCLUDE[vmm12sp1_long](../../includes/vmm12sp1_long_md.md)]. For example, you may want to add or remove an associated network site, or modify an IP address pool.
