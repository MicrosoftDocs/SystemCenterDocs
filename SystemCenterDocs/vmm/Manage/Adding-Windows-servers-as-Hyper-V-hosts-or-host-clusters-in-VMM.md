...
|Host groups|-   **HyperVHost01.contoso.com** could be added to the host group **Seattle\SEA_Tier0**<br />-   **HyperVHost02.fabrikam.com** could be added to the host group **New York\NY_Tier2**<br />-   **HyperVHost03** could be added to the host group **New York\NY_Tier1**<br />-   **HyperVHost04** could be added to the host group **Seattle\SEA_Tier2**|
