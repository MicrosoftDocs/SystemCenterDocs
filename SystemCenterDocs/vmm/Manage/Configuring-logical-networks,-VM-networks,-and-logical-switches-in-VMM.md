...
You can use [!INCLUDE[vmm12sp1_long](../../includes/vmm12sp1_long_md.md)] to manage your physical and virtualized network infrastructure. In [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)], the foundations of the network configuration are networks—the underlying logical networks and the VM networks—and switches. Switches can be configured as standard virtual switches, but this set of topics describes logical switches, which help you configure switch settings consistently across multiple hosts. To configure these network elements in [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)], use the following overviews and procedures, in the order shown.
...
Optionally, configure global network settings, which have an effect only when you add a host to [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)] and you don't have any logical networks associated with physical network adapters on that host. In that situation, [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)] can use your settings to create a logical network automatically:
...
After you have planned your logical networks, VM networks, and logical switches \(and the elements within them, such as network sites within logical networks\), use the following procedures, in order, to create your network configuration in [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)]:
