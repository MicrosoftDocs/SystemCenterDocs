...
With [!INCLUDE[vmm12sp1_long](../../includes/vmm12sp1_long_md.md)] you can configure, deploy, and manage the virtual Non\-Uniform Memory Access \(NUMA\) features that were introduced in Hyper\-V in [!INCLUDE[win8_server_2](../../includes/win8_server_2_md.md)].
