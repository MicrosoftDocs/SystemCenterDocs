...
This procedure describes how to migrate a virtual machine in [!INCLUDE[vmm12sp1_long](../../includes/vmm12sp1_long_md.md)]. To perform a migration, you can use any of the following actions:
...
9. To begin deploying the virtual machine, click **Move**.
    ...
    To review the progress and results of the operation, open the **Jobs** workspace. By default, the workspace opens when the wizard closes. To open this workspace at any time, click **Jobs** on the [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)] console toolbar.
...
> [!NOTE]
> If you encounter difficulties using drag\-and\-drop, log out of [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)], and then log back in and try again. Also try restarting the virtual machine and then try again.
