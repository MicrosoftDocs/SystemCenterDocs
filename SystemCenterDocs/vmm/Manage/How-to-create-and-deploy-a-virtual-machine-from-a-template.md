...
Use the following procedure to create a virtual machine from a virtual machine template in [!INCLUDE[vmm12sp1_long](../../includes/vmm12sp1_long_md.md)]. You can use a virtual machine template to create new stand\-alone virtual machines or to create tiers in a service template. For more information about service templates, see [Creating service templates in VMM](Creating-service-templates-in-VMM.md).
...
-   To configure a virtual machine to use static IP addresses from an IP address pool that is managed by [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)], you must use a virtual machine template as the source.
