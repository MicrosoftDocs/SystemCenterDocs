...
The topics in this section describe the process for creating a host cluster in [!INCLUDE[vmm12sp1_long](../../includes/vmm12sp1_long_md.md)], using existing servers running a Windows Server operating system:
...
## <a name="BKMK_workflow"></a>How [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)] creates a Hyper\-V host cluster
