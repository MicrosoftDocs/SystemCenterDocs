...
The provider software for an IPAM server running Windows Server 2012 R2 or Windows Server Technical Preview is already included in the VMM management server in System Center 2016 Technical Preview. You do not have to install it. If you want to review the provider software on your VMM server, open the **Settings** workspace and in the **Settings** pane, click **Configuration Providers**. The list of providers appears in the **Configuration Providers** pane.

#### To add an IPAM server in VMM
