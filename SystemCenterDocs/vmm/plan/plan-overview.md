...
-  [Plan a VMM high availability deployment](../plan-ha-install.md). You can optionally deploy the VMM management server, SQL Server database, and library server in high availability mode.
