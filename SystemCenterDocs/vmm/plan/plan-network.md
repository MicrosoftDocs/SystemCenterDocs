...
**Load balancers** | VMM supports adding hardware load balancers or using NLB to load balance requests to a [service tier](vmm-manage-add-service-templates.md)
