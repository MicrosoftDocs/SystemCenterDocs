...
You can add and manage SOFS clusters in the System Center - Virtual Machine Manager (VMM) fabric. There are a number of ways you can add an SOFS cluster. You can add an existing SOFS cluster to the fabric,  provision an SOFS cluster from existing Windows machines in the fabric, or provision a cluster from bare metal computers.
