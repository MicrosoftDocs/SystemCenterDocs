...
>     - Check the DiskSpacePlacementLevel of the host group using the Get-SCHostReseve cmdlet. Set the DiskSpacePlacementLevel value equal to the value of Disk Space set in Host Reserve settings in the Dynamic Optimization wizard.
