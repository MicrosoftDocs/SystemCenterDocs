...
**Physical computers** | Operating system | You can add a Windows Server 2016 node to a Windows Server 2012 R2 cluster, subject to the requirements specified previously; however, you cannot add a Windows Server 2012 R2 node to a Windows Server 2016 cluster.<br> **Note:** VMM 2019 UR3 and later supports [Azure Stack Hyper Converged Infrastructure (HCI)](deploy-manage-azure-stack-hci.md).
