...
VMM 1801 onwards supports QoS on all managed clusters and also SOFS, running on Windows Server 2016 and beyond.
...
## Assign  a storage QoS Policy from templates
   ...
   With VMM 1801 onwards, you can select storage QoS policies from a template as well. For information on how to assign storage QoS policies from templates, see the related procedure in  [create a VM template](library-vm-templates.md) article.
