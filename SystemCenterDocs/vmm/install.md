...
>[!NOTE]
> gMSA, when used as VMM Service account, needs to have *logon as a service* and *Replace process level* token permissions. Without these permissions, you cannot create clusters.  
