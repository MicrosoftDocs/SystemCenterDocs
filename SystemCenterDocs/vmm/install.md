...
1. On the **Diagnostic and Usage Data** page, 
    1. Review Microsoft's data collection policy and how to disable data collection. Then select **Next**.
1. If the **Microsoft Update** page appears, 
...
1. On the **Installation summary** page, 
    1. Review your selections and then select **Install**. The **Installing features** page appears and displays the installation progress.
