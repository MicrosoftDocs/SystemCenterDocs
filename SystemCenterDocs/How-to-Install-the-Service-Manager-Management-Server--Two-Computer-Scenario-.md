...
As the first step in the two\-computer installation process, install the [!INCLUDE[smshort12](../Token/smshort12_md.md)] management server, the [!INCLUDE[smshort12](../Token/smshort12_md.md)] database, and the [!INCLUDE[smcons](../Token/smcons_md.md)] on one of the two computers.
...
2.  On the [!INCLUDE[smshort12](../Token/smshort12_md.md)] installation media, double\-click the **Setup.exe** file.
...
5.  On the **Installation location** page, verify that sufficient free disk space is available, and then click **Next**. If necessary, click **Browse** to change the location in which the [!INCLUDE[smshort12](../Token/smshort12_md.md)] management server will be installed.
...
7.  On the **Configure the Service Manager database** page, [!INCLUDE[smshort12](../Token/smshort12_md.md)] will check the current computer to see if an instance of SQL Server exists. By default, if an instance is found, [!INCLUDE[smshort12](../Token/smshort12_md.md)] creates a new database in the existing instance. If an instance appears, click **Next**.
