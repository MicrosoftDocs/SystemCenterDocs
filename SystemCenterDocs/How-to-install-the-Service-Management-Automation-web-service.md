...
13. Review the installation summary, and then click **Install**.
    ...
    After the installation is complete, install a runbook worker as described in [How to install the Service Management Automation runbook worker](../Topic/How-to-install-the-Service-Management-Automation-runbook-worker.md).
