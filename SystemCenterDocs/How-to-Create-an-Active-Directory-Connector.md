...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 6a239542-a21a-4b9c-a0b0-f5a8205f67db
---
...
4.  Complete these steps in the Active Directory Connector Wizard:
    ...
    7.  On the **Select objects**, do the following:
        ...
        If you want new users that are added to any groups you import to be added automatically to [!INCLUDE[smshort](Token/smshort_md.md)], select **Automatically add users of AD Groups imported by this connector**, and then click **Next**.
...
![](Image/PSSymbol.gif)You can use a Windows PowerShell command to create a new [!INCLUDE[smshort](Token/smshort_md.md)] Active Directory connector. For information about how to use Windows PowerShell to create a new [!INCLUDE[smshort](Token/smshort_md.md)] Active Directory connector, see [New\-SCADConnector](http://go.microsoft.com/fwlink/?LinkId=225349).
