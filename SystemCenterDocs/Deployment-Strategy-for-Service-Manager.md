...
As a best practice, deploy your management servers and associated databases for [!INCLUDE[smlong12](../Token/smlong12_md.md)] on separate computers. Isolating the management servers and databases provides for a successful disaster recovery operation in the event of potential software and equipment failures.
