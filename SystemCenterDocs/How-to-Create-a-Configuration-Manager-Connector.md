...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 0475d508-e001-4db0-9367-6490026545f7
---
# How to Create a Configuration Manager Connector
You can use the following procedures to create a connector to import data from Configuration Manager into Service Manager and confirm the status of the connector.
...
6.  On the **Select Management Pack** page, in the **Management Pack** list, select **System Center Configuration Manager Connector Configuration**, and then click **Next**.
