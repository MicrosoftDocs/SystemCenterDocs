...
Using an Active Directory connector, Service Manager synchronizes data with the User, Group, Computer, and Printer Active Directory Domain Services \(AD DS\) objects. The following tables describe the mapping between the attributes of the Active Directory objects and the corresponding [!INCLUDE[smshort](../../includes/smshort_md.md)] class properties.

## User\/Microsoft.AD.User
The following table describes the mapping between the attributes of the Active Directory User object and the  [!INCLUDE[smshort](../../includes/smshort_md.md)] **Microsoft.AD.User** class properties.
...
The following table describes the mapping between the attributes of the Active Directory Group object and the [!INCLUDE[smshort](../../includes/smshort_md.md)] **Microsoft.AD.UserBase** class properties.
...
The following table describes the mapping between the attributes of the Active Directory PrintQueue object and the [!INCLUDE[smshort](../../includes/smshort_md.md)] **Microsoft.AD.Printer** class properties.
...
The following table describes the mapping between the attributes of the Active Directory Computer object and the  [!INCLUDE[smshort](../../includes/smshort_md.md)] **Microsoft.Windows.Computer** class properties.
