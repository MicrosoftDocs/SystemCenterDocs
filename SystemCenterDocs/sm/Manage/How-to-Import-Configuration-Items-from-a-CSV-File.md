...
![](../../media/PSSymbol.gif)You can use a Windows PowerShell command to complete this task. For information about how to use Windows PowerShell to import configuration items from a CSV file, see [Import\-SCSMInstance](http://go.microsoft.com/fwlink/p/?LinkId=225348).
