...
You can use the following procedures to manually create two computer configuration items. However, you can also use the same procedures to add software, printers, or software updates in [!INCLUDE[smshort](../../includes/smshort_md.md)]. After you add the two computers, you can identify them as a service.
