---
title: Guidance for Installing System Center - Service Manager on Virtual Machines
manager:  cfreeman
ms.custom: na
...
# Guidance for Installing System Center - Service Manager on Virtual Machines

>Applies To: System Center 2016 - Service Manager

This topic provides guidance that you have to consider when you install System Center - Service Manager in a Hyper\-V virtual environment. If you are installing Microsoft SQL&nbsp;Server into an environment without Hyper\-V, consult your vendor's documentation for guidance regarding the use of SQL&nbsp;Server.  
