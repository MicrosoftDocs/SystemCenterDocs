...
4. Review the information at [Move the Service Manager and data warehouse databases](deploy-appendix-b-guidance-for-moving-the-service-manager-and-data-warehouse-databases#move-the-service-manager-database.md)  and follow the steps there, with the following changes:
