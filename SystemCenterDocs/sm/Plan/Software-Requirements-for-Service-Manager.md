...
If your SQL Server installation is using the default collation (SQL_Latin1_General_CP1_CI_AS), a warning message appears, stating that the collation is not one of the supported collations for System Center 2016 Technical Preview - Service Manager and that an unsupported collation can cause unpredictable behavior in multilingual environments.
