...
-   [Account Used for Running Setup](plan-account-used-for-running-setup.md)  
     ...
     Describes how to ensure needed account requirements are met.  

-   [Accounts Required During Setup](plan-accounts-required-during-setup.md)  

     Describes how to ensure accounts are ready for the Setup process.