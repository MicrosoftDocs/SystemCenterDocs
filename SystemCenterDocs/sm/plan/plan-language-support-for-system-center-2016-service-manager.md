...
- Review [Databases created by Service Manager](plan-databases-created-by-system-center-2016-service-manager.md) to learn about the databases that are created during Service Manager deployment.
