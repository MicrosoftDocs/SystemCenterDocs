...
All SQL Server requirements are listed at [SQL Server](../../system-requirements/sql-server-version-compatibility.md).
...
For more information about installing Service Manager with AlwaysOn availability groups, [refer here](../deploy/deploy-using-sql-server-2014-alwayson-availability-groups-with-service-manager).
