...
-   [Sample Scenarios: Managing Incidents and Problems](ops-sample-scenarios-managing-incidents-and-problems.md)  

     Describes the scenarios that involve incidents and problems in Service Manager.  

-   [Managing Incidents](ops-managing-incidents.md)  

     Describes how to create, edit, and resolve incidents and incident views.  

-   [Troubleshooting Incidents](ops-troubleshooting-incidents.md)  

     Describes how to troubleshoot incidents by using service maps and by running tasks.  

-   [Managing Problems](ops-managing-problems.md)  
