---
title: Change the credentials for the SQL Server Reporting Services account
description: Describes how to change the credentials for the SQL Server Reporting Services account used by Service Manager.
manager: carmonm
ms.topic: article
author: bandersmsft
ms.author: banders
