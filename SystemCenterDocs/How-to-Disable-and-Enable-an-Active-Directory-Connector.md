...
1.  After you enable or disable an Active Directory connector, wait for about 30 seconds. Then, in the [!INCLUDE[smcons](Token/smcons_md.md)], click **Administration**, and then click **Connectors**.
...
-   For information about how to use Windows PowerShell to update properties of a [!INCLUDE[smshort](Token/smshort_md.md)] connector, see [Update\-SCSMConnector](http://go.microsoft.com/fwlink/p/?LinkID=225382).
