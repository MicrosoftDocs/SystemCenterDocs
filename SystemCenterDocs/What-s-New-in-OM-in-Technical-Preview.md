...
For specific instructions on how to configure [!INCLUDE[scom_threshold_1](../Token/scom_threshold_1_md.md)] to monitor Nano Server, see [Monitoring Nano Server](../Topic/Monitoring-Nano-Server.md).
