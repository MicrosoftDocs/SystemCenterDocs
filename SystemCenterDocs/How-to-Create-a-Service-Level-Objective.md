...
9. On the **Service Level Criteria** page, select a calendar and a time metric, or you can create new ones. [!INCLUDE[crabout](./Token/crabout_md.md)] creating a calendar, see [How to Edit a Calendar Item](How-to-Edit-a-Calendar-Item.md). [!INCLUDE[crabout](./Token/crabout_md.md)] creating an SLA metric, see [How to Create SLA Metrics](How-to-Create-SLA-Metrics.md).
