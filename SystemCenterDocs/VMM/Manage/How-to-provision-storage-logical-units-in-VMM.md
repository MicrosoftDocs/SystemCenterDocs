...
You can use the following procedure to create logical units from storage pools that are managed by [!INCLUDE[vmm12sp1_long](../../includes/vmm12sp1_long_md.md)].
...
Before you begin this procedure, ensure that one or more storage pools are defined in [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)] management. For more information, see [Overview: configuring block storage VMM](Overview--configuring-block-storage-VMM.md) and [How to add and classify SMI-S and SMP storage devices in VMM](How-to-add-and-classify-SMI-S-and-SMP-storage-devices-in-VMM.md).
