...
|-------------------------------|---------------------------------------------------------|
|1. Logical networks already created by default by [!INCLUDE[vmm12short](Token/vmm12short_md.md)]|When you add a Hyper\-V host to [!INCLUDE[vmm12short](Token/vmm12short_md.md)], logical networks may be created by default, based on DNS suffixes. See [Logical networks created by default](Overview--plan-logical-networks,-network-sites,-and-IP-address-pools-in-VMM.md#BKMK_default) in this topic.|
