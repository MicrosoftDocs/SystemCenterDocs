...
This section provides an overview of migration in [!INCLUDE[vmm12sp1_long](../../includes/vmm12sp1_long_md.md)] and includes procedures to migrate a virtual machine by using the Migrate Virtual Machine Wizard or a drag\-and\-drop operation, to perform a quick storage migration, and to run a live migration.
