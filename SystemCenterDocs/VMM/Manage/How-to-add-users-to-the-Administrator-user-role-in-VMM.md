...
The Administrator user role is created when you install [!INCLUDE[vmm12sp1_long](../../Token/vmm12sp1_long_md.md)]. The user who performs the [!INCLUDE[vmm12short](../../Token/vmm12short_md.md)] installation and all domain users in the Local Administrators group are added to the Administrator user role.

Use this procedure to add users to the Administrator user role in [!INCLUDE[vmm12short](../../Token/vmm12short_md.md)] or remove users from the user role.
