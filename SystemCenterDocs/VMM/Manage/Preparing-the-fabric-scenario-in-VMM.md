...
The example scenario that is used in this section illustrates one way to configure the fabric with [!INCLUDE[vmm12sp1_long](../../includes/vmm12sp1_long_md.md)], including sample host groups, library shares, networking resources, and storage resources. Because some of these examples depend on your existing hardware and physical infrastructure, consider the examples as guidelines. For more information, see the topics listed in [Managing Fabric Resources in VMM](Managing-fabric-resources-in-VMM.md).
