...
4.  Brings the computer under [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)] management as a managed Hyper\-V host

### To deploy Hyper\-V hosts from bare metal in [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)]
...
11. On the **Summary** page, confirm the settings, and then click **Finish** to deploy the new Hyper\-V hosts and bring them under [!INCLUDE[vmm12short](../../includes/vmm12short_md.md)] management.
