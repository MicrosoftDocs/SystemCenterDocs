...
If you deploy virtual machines on a host cluster, you can use [!INCLUDE[vmm12sp1_long](../../includes/vmm12sp1_long_md.md)] to configure preferred owners and possible owners for the virtual machines. By default, there are no preferred owners \(there is no preference\), and the possible owners include all nodes \(servers\) in the host cluster.
