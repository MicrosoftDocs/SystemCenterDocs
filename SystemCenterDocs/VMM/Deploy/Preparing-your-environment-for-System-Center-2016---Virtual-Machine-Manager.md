...
For more information about library servers in [!INCLUDE[vmm12short](../../Token/vmm12short_md.md)], see [Configuring the VMM library](../Manage/Configuring-the-VMM-library.md).
...
-   How to manage Hyper\-V hosts in [!INCLUDE[vmm12short](../../Token/vmm12short_md.md)]: see [Adding Windows servers as Hyper-V hosts or host clusters in VMM](../Manage/Adding-Windows-servers-as-Hyper-V-hosts-or-host-clusters-in-VMM.md).
...
For more information about update management in [!INCLUDE[vmm12short](../../Token/vmm12short_md.md)], see [Managing fabric updates in VMM](../Manage/Managing-fabric-updates-in-VMM.md).
