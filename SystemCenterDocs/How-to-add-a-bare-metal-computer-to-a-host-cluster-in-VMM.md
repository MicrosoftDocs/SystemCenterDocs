...
2. On the **Resource Type** page, select **Physical computers to be provisioned**, then fill in the options:
	...
	- Specify the Administrator Run As account that [!INCLUDE[vmm12short](../Token/vmm12short_md.md)] will use.
...
12. On the **Summary** page, confirm the settings, and then click **Finish** to provision the computers and add them to the cluster under [!INCLUDE[vmm12short](../Token/vmm12short_md.md)] management.
