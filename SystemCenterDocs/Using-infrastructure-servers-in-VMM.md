...
|-------------|---------------|
|[How to add an infrastructure server to VMM](../Topic/How-to-add-an-infrastructure-server-to-VMM.md)|Describes how to add an infrastructure server.|
|[How to view infrastructure servers in VMM](../Topic/How-to-view-infrastructure-servers-in-VMM.md)|Describes how to view a list of infrastructure servers and the properties of infrastructure servers.|
|[How to remove an infrastructure server from VMM](../Topic/How-to-remove-an-infrastructure-server-from-VMM.md)|Describes how to remove an infrastructure server.|
...
[How to remediate updates on infrastructure servers in VMM](../Topic/How-to-remediate-updates-on-infrastructure-servers-in-VMM.md)
