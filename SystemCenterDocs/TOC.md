...
##### [Configuration Manager](orch/manager/configuration-manager-integration-pack.md)
###### [Configuration Manager Activities](orch/manager/configuration-manager-activities.md)
####### [Deploy Application](orch/manager/deploy-application.md)
####### [Deploy Configuration Baseline](orch/manager/deploy-configuration-baseline.md)
####### [Deploy Program](orch/manager/deploy-program.md)
####### [Deploy Software Update](orch/manager/deploy-software-update.md)
####### [Deploy Task Sequence](orch/manager/deploy-task-sequence.md)
####### [Get Collection Member](orch/manager/get-collection-member.md)
####### [Get Deployment Status](orch/manager/get-deployment-status.md)
####### [Perform Client Action](orch/manager/perform-client-action.md)
####### [Query Configuration Manager](orch/manager/query-configuration-manager.md)
####### [Update Collection Membership](orch/manager/update-collection-membership.md)
...
#### [Manage incidents and problems in Service Manager](sm/manage/ops-managing-incidents-and-problems-in-system-center-2016-service-manager.md)
...
#### [Manage Service Manager release records](sm/manage/ops-managing-release-records-in-system-center-2016-service-manager.md)
...
##### [Overview of Service Manger OLAP cubes for advanced analytics](sm/manage/ops-using-olap-cubes-for-advanced-analytics.md)
###### [Modeling Service Manager OLAP cubes in management packs overview](sm/manage/ops-about-modeling-olap-cubes-in-management-packs.md)
...
###### [Analyze Service Manager OLAP cube data with Excel](sm/manage/ops-analyzing-data-with-excel.md)
###### [How to Refresh OLAP Data Cube Information](sm/manage/ops-how-to-refresh-olap-data-cube-information.md)
###### [Manage and use the analysis libraries in the Service Manager console](sm/manage/ops-how-to-manage-the-analysis-libraries.md)
