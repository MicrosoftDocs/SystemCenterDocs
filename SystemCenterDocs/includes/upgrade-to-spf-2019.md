...
3. Install the prerequisites on the new VM, as follows:
    ...
    - Install [SQL Native Client](https://www.cdata.com/odbc/)
    - Install SQL Server [command line utilities](https://www.cdata.com/odbc/).
    - Install SQL Server [CLR types](https://www.cdata.com/odbc/).
