...
See the article, [Screenshot showing how to add disks to increase legacy storage.](#add-disks-to-increase-legacy-storage) for more information on adding disks. You can't give disks a friendly name.
