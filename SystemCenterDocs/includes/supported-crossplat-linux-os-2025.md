...
>[!NOTE]
>If you encounter a discovery error **Azure Linux not supported** for any Linux VMs deployed in Azure, see [Troubleshoot discovery error - Azure Linux not supported](troubleshoot-discovery-error.md).
