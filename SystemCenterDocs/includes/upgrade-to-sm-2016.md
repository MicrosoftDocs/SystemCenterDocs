...
> [!IMPORTANT]  
>  It's assumed in this guide that you're performing an *upgrade* to System Center 2012 R2. For information about installing System Center 2016 - Service Manager on a computer where no previous version of Service Manager exists, see the [Deploying System Center 2016 - Service Manager](../scsm/deploy-sm.md).  
