...
When you view an alert's detail in an alert's view, you can see whether the alert was generated by a rule or a monitor. If the alert was generated by a monitor, as a best practice, you should allow the monitor to auto resolve the alert when the health state returns to healthy.
...
For additional requirements, see Operations Manager 2019 [system requirements](../includes/system-reqs-om-2019.md).
