...
Management server failover is a crucial feature to enable high-availability and provide fault tolerance in production environments. SCOM 2019 is enhanced for handling failover and load-balancing scenario for Linux/UNIX computers and network devices.
...
The existing alert notifications and subscription experience in SCOM has been enhanced to deliver more value to the end user. These enhancements can be broadly categorized into the following two areas:
