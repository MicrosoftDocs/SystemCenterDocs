...
When you view an alert's detail in the alerts view, you can see whether the alert was generated by a rule or a monitor. If the alert was generated by a monitor, as a best practice, allow the monitor to autoresolve the alert when the health state returns to healthy.
...
See the following sections for information about the new features or feature updates supported in Operations Manager 2019 Update Rollup 1 (UR1).
...
The existing management packs for Red Hat Enterprise Linux (RHEL) 7 and SLES 12 will continue to work. The universal management packs support discovering and monitoring RHEL 8, SLES 15, and any new platforms that we intend to support in the future.
