...
[Azure Stack Hyper Converged Infrastructure (HCI)](../vmm/deploy-manage-azure-stack-hci.md) (supported from 2019 UR3 and later)| Y | Y | If supported by SQL Server version 
