...
In addition, you must use the script that you created in the [Backing Up Unsealed Management Packs in Service Manager](./Backing-Up-Unsealed-Management-Packs-in-Service-Manager.md) section in this guide. You use this script to restore permissions for the recreated database.
