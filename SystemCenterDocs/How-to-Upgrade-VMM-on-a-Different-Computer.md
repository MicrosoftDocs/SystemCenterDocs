...
2.  Uninstall the current [!INCLUDE[vmm12short](../Token/vmm12short_md.md)] deployment. On the **Uninstallation Options** page, select **Retain data**. For more information, see [How to Uninstall VMM](../Topic/How-to-Uninstall-VMM.md).
...
[How to Install a VMM Management Server](../Topic/How-to-Install-a-VMM-Management-Server.md)
