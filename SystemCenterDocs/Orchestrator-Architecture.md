...
|Runbook Designer|The Runbook Designer is the tool used to build, edit, and manage [!INCLUDE[orchshort](Token/orchshort_md.md)] runbooks. For more information about the Runbook Designer, see [Using Runbooks in System Center 2012 - Orchestrator](Using-Runbooks-in-System-Center-2012---Orchestrator.md).|
...
The following table shows multiple strategies available for extending the functionality provided by a standard installation of [!INCLUDE[orchshort](Token/orchshort_md.md)]. For additional information, see [Deploying System Center 2012 - Orchestrator](Deploying-System-Center-2012---Orchestrator.md).
