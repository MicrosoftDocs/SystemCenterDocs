...
-   [How to upgrade a Scale-Out File Server to Windows Server Technical Preview](../Topic/How-to-upgrade-a-Scale-Out-File-Server-to-Windows-Server-Technical-Preview.md)
