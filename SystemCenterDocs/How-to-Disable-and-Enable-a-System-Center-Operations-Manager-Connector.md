...
For example, after you configure an Operations Manager connector, if you must perform maintenance operations on the [!INCLUDE[smshort](./Token/smshort_md.md)] database, you can temporarily disable the connector and suspend the data import. You can resume the data import by re\-enabling the connector.
...
1.  Wait 30 seconds. Then, in the [!INCLUDE[smcons](./Token/smcons_md.md)], click **Administration**, and then click **Connectors**.
...
-   For information about how to use Windows PowerShell to retrieve connectors that are defined in [!INCLUDE[smshort](./Token/smshort_md.md)] and view their status, see [Get\-SCSMConnector](http://go.microsoft.com/fwlink/p/?LinkId=225320).

-   For information about how to use Windows PowerShell to update the properties of a [!INCLUDE[smshort](./Token/smshort_md.md)] connector, see [Update\-SCSMConnector](http://go.microsoft.com/fwlink/p/?LinkID=225382).
