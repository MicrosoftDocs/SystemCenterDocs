...
-   [Overview of Service Management Automation](../Topic/Overview-of-Service-Management-Automation.md)

    Provides a brief overview of the purpose and capabilities of [!INCLUDE[smalong](../Token/smalong_md.md)].

-   [Architecture of Service Management Automation](../Topic/Architecture-of-Service-Management-Automation.md)
