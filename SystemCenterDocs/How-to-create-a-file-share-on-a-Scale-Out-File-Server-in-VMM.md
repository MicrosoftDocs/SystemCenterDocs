...
For details about what [!INCLUDE[vmm12short](Token/vmm12short_md.md)] does when creating the file share, see [Stage 4: Create file shares](Overview--configuring-storage-using-Scale-Out-File-Servers-in-VMM.md#BKMK_shares) in "Overview: configuring storage using Scale\-Out File Server clusters in VMM."
