...
1.	Physically connect the additional disks that you want to add and   [initialize these disks](add-storage#initialize-disks).
...
3.	Select the disk from the list of available disks, and click **OK**.
  ...
  Server Manager displays the updated capacity. Now, you can extend the volume size.
