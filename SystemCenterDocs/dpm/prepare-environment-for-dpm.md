...
|Requirement|Details|
|-----------|-------|
|Operating System|Windows Server 2019, Datacenter, and Standard editions (Windows Server Core 2019 is supported)<br/> Windows Server 2016, Datacenter, and Standard editions<br/>Windows Server 2012 R2, Datacenter, and Standard editions (Not applicable for DPM 2019) |
