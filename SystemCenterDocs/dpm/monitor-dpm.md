...
- To view the list of backup items, select *DPM* or *Azure Backup Server* under **Backup Management Type**.   
  ...
  > - Currently datasources backed directly to tape do not appear in recovery services vault. Please back up to disk for the short term if you require the datasources to appear in recovery services vault.
