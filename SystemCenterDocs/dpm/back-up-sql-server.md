...
>[!NOTE]
>SQL Connections uses [OLEDB 19](/sql/connect/oledb/download-oledb-driver-for-sql-server?view=sql-server-ver16&preserve-view=true) (19.3 and above), which must be installed on all SQL Server machines.
