...
1. [Register your DPM Server to the vault](register-public-access-vault-backup-server.md#re-register-the-dpm-server-with-vault) you created with private endpoints.
