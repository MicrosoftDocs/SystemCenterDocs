...
2.  On the [!INCLUDE[dpm2012short](../../includes/dpm2012short_md.md)] server, run `Attach-NonDomainServer.ps1 –DpmServername Server01 -PSName Finance01 -Username mark`.
...
2.  On the [!INCLUDE[dpm2012short](../../includes/dpm2012short_md.md)] server, run `Attach-NonDomainServer.ps1 -DPMServername Server01.corp.contoso.com -PSName Finance01.widgets.corp.com -Username mark`.
