...
|Linux|Linux running as Hyper-V guest (Hyper-V running on Windows Server 2019) |On-premises Hyper-V virtual machine|Hyper-V must be running on Windows Server 2019 or Windows Server 2016. Protect: Entire virtual machine<br /><br />Recover: Entire virtual machine <br/><br/> For a complete list of supported Linux distributions and versions, see the article, [Linux on distributions endorsed by Azure](http://docs.microsoft.com/azure/virtual-machines/linux/endorsed-distros).|
