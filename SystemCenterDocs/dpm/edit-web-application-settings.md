...
You can however, ignore the server certificate errors if you wish to, while monitoring  website. To facilitate this option, we have introduced a new option **Ignore Server Certificate Errors**.  To monitor a website for which there is no valid SSL certificate, select this checkbox.   
