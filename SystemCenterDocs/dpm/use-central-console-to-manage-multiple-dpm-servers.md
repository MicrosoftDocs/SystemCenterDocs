...
1.  Deploy an Operations Manager agent to your DPM server.  [Read more](#use-ops-manager-to-manage-monitor-dpm.md?view=sc-dpm-1807&preserve-view=true#BKMK_OM).
