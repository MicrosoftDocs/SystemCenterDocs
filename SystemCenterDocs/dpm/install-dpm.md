...
|SQL Server prerequisites<br />|-   Use any of the following SQL platforms:<ul><li> 64-bit SQL Server 2017 Enterprise or Standard, only for DPM 1801 onwards. <br/> **Note**: To use SQL 2017 as a DPM database, you must [upgrade SQL 2016 to SQL 2017](install-dpm.md#upgrade-sql-2016-to-sql-2017). <li> 64-bit SQL Server 2016 SP1 Enterprise or Standard, only for DPM 1801 onwards <li> 64-bit SQL Server 2016 Enterprise or Standard, <br/> **Note**: To use SQL 2016, you must immediately install DPM 2016 UR2 after installing DPM 2016. You cannot install DPM 2016 on SQL 2016 SP1. <li> 64-bit SQL Server 2014 Enterprise or Standard, <li> 64-bit SQL Server 2012 SP2 Enterprise or Standard </ul> -   You can install SQL Server on the DPM server or on a remote server.  If you install remotely the server remote instance must be in the same domain and time zone as the DPM server. </br>- You can't run SQL Server on a domain controller.<br />-   Get the local or remote SQL Server up and running before you install DPM.<br />-   SQL Server can be standalone or running in a cluster.<br />-   You can't use a SQL Server Always-On deployment.<br />-   If you deploy DPM as an Azure virtual machine (VM) use an Azure VM running SQL Server as a remote SQL Server instance. You can't use an on-premises SQL Server in this deployment, and using an Azure SQL Database isn't currently supported.<br />-   If SQL Server is clustered, Reporting Server and SQL Server should be on different machines.|
