...
|Recalculate monitor state after recovery finishes<br /><br />\(Recoveries only\)|Specifies whether the recovery should initiate a recalculation of the monitor health state after completing. This is described in [Recalculating State](./Diagnostics-and-Recoveries.md#Recalculating).|
...
1.  Create a monitor using a procedure from one of the topics in [Monitors and Rules](./Monitors-and-Rules.md).
