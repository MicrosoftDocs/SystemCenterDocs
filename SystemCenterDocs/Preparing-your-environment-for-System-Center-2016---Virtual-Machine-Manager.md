...
For more information, see [VMM support for VMware](./VMM-support-for-VMware.md).
...
For more information, see [How to add existing servers or clusters as Hyper-V hosts or host clusters in VMM](./How-to-add-existing-servers-or-clusters-as-Hyper-V-hosts-or-host-clusters-in-VMM.md).
