...
1.  Open the [!INCLUDE[smcons](../../includes/smcons_md.md)], and then select **Administration**.
...
7.  In **Maximum number of e\-mails to process at a time**, type a number for the emails that you want [!INCLUDE[smshort](../../includes/smshort_md.md)] to process during an email processing cycle.
