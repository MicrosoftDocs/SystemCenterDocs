...
### To change the log\-on password for the [!INCLUDE[smshort](../../includes/smshort_md.md)] Data Access and [!INCLUDE[smshort](../../includes/smshort_md.md)] Management Configuration services
