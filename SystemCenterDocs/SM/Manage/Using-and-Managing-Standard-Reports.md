...
-   Schedule a standard [!INCLUDE[smshort](../../includes/smshort_md.md)] report.

-   Add reports to the report catalog that were not created in [!INCLUDE[smshort](../../includes/smshort_md.md)].
