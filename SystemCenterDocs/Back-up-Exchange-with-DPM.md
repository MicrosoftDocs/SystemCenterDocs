...
-   Review the [Release Notes for System Center Technical Preview 5](Release-Notes-for-System-Center-Technical-Preview-5.md) and [What's supported and what isn't for DPM?](What-s-supported-and-what-isn-t-for-DPM-.md) to check for any Exchange issues.
