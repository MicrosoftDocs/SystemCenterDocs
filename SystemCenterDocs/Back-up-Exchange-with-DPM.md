...
-   Review the [Release Notes for System Center Technical Preview 5](../Topic/Release-Notes-for-System-Center-Technical-Preview-5.md) and [What's supported and what isn't for DPM?](../Topic/What-s-supported-and-what-isn-t-for-DPM-.md) to check for any Exchange issues.
...
3.  **Set up the DPM protection agent**—The agent needs to be installed on the Exchange server.  Read [Deploy the DPM protection agent](../Topic/Deploy-the-DPM-protection-agent.md).
