...
To ensure that resources, such as applications and systems, are available and performing at acceptable levels, companies set goals for their service availability and response times. [!INCLUDE[om12long](../../Token/om12long_md.md)] provides the capability to monitor these service goals by tracking service level objectives.
