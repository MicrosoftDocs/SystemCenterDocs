...
## Prerequisites
Before you can perform these procedures, you must have set up update management in [!INCLUDE[vmm12short](../Token/vmm12short_md.md)]. For more information, see [Managing fabric updates in VMM](../Topic/Managing-fabric-updates-in-VMM.md).
...
|-------------|---------------|
|[How to remediate updates on a stand-alone Hyper-V host in VMM](../Topic/How-to-remediate-updates-on-a-stand-alone-Hyper-V-host-in-VMM.md)|Describes how to install updates on noncompliant Hyper\-V hosts.|
|[How to perform rolling updates on a Hyper-V host cluster in VMM](../Topic/How-to-perform-rolling-updates-on-a-Hyper-V-host-cluster-in-VMM.md)|Describes how to perform rolling update remediation on a Hyper\-V host cluster.|
|[How to remediate updates on infrastructure servers in VMM](../Topic/How-to-remediate-updates-on-infrastructure-servers-in-VMM.md)|Describes how to install updates on infrastructure servers in [!INCLUDE[vmm12short](../Token/vmm12short_md.md)].|
