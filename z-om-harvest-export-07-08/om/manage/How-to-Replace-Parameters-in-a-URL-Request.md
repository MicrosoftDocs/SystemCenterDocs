...
![Bing Homepage](../../om/manage/media/OM2007_UsersGuide_BingHomepage.gif "OM2007_UsersGuide_BingHomepage")  
...
![Bing Popular Now Search String](../../om/manage/media/OM2007_UsersGuide_PopularNowSearchStringHTML.gif "OM2007_UsersGuide_PopularNowSearchStringHTML")  
...
1.  Use the procedure in [How to Capture Web Application Recording](../../om/manage/How-to-Capture-Web-Application-Recording.md) to record a web application.  
...
6.  Remove the last request because this is not required. To remove the last request, select the request, and then click **Delete** in the **Actions** pane. The resulting requests should look similar to the following URLs:  
    ...
    ![Bing Web Application Recorded](../../om/manage/media/OM2007_UsersGuide_WebAppRecorded.gif "OM2007_UsersGuide_WebAppRecorded")  
...
6.  In the **Ends with** box, type **"**. The extraction rule should look similar to the following illustration.  
    ...
    ![Extraction Rule](../../om/manage/media/OM2007_UsersGuide_ExtractionRule.gif "OM2007_UsersGuide_ExtractionRule")  
...
4.  With the cursor positioned at the end of the URL, just after **www.bing.com**, select **SearchString** in the **Parameters** box, and then click **Insert**. This inserts the variable `$ParametersContext/SearchString$`. The final request looks similar to the following illustration.  
    ...
    ![Insert Parameter](../../om/manage/media/OM2007_UsersGuide_InsertParameter.gif "OM2007_UsersGuide_InsertParameter")  
...
6.  Click **OK** to save and close the request. The modified request sequence should look similar to the following illustration.  
    ...
    ![Bing Web Application Modified](../../om/manage/media/OM2007_UsersGuide_WebAppModified.gif "OM2007_UsersGuide_WebAppModified")  
