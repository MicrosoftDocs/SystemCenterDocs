...
The database can reside on any computer whether it has an agent for [!INCLUDE[om12short](../../om/manage/includes/om12short_md.md)] installed or not, but it must be accessible from the watcher nodes. Each watcher node must have an [!INCLUDE[om12short](../../om/manage/includes/om12short_md.md)] agent installed.  
...
You can view the state of the individual database monitors by opening the [!INCLUDE[om12short](../../om/manage/includes/om12short_md.md)] Health Explorer for each object. You can view performance data by opening the Performance view for each of these objects.  
...
|Management Pack|Management pack to store the classes, monitors, and rules that the template created.<br /><br />For more information about management packs, see [Selecting a Management Pack File](../../om/manage/Selecting-a-Management-Pack-File.md).|  
...
|Option|Description|  
|----------|---------------|  
|Select one or more agent\-managed computers|Specify one or more agent\-managed computers to run the monitor. For more information, see [Watcher Nodes](../../om/manage/Watcher-Nodes.md).|  
...
14. Select one or more [Watcher Nodes](../../om/manage/Watcher-Nodes.md) to run the monitor.  
...
17. If a Run As account with credentials that have access to the database does not exist, create an appropriate Run As account in the **Administration** workspace. For more information, see [How to Create a Run As Account](../../om/manage/How-to-Create-a-Run-As-Account.md).  
