...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 7a62ddcc-a2d5-4467-8b53-c595c52f1221
author:markgalioto
---
...
The HTTP requests are sent from one or more [Watcher Nodes](../../om/manage/Watcher-Nodes.md). The website that is being monitored can reside on any computer whether it has an agent for [!INCLUDE[om12short](../../om/manage/includes/om12short_md.md)] installed. It can be an external website, but it must be accessible from the watcher nodes. Each watcher node must have an [!INCLUDE[om12short](../../om/manage/includes/om12short_md.md)] agent installed.  
...
-   [How to Create a Single URL Web Application Monitor](../../om/manage/How-to-Create-a-Single-URL-Web-Application-Monitor.md)  
...
-   [How to Replace Parameters in a URL Request](../../om/manage/How-to-Replace-Parameters-in-a-URL-Request.md)  
