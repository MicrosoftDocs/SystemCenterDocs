...
1.  On the server where you want to install Service Provider Foundation, double\-click **SetupOrchestrator.exe** on the installation media to start the System Center 2012 Orchestrator  2012 R2 Setup Wizard.  
