...
Use one of the following two procedures to browse a form in the System Center 2016 - Service Manager Authoring Tool. In both procedures, note that the properties in the **Details** pane are updated according to the class property that is bound to the selected control. And, note that the **Binding Path** entry in the **Details** pane indicates the respective property that the field in the form represents.  
