...
You can use the following procedure to reinstall a management server in [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)].  
...
1.  Log on to the computer that will host the new [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] management server using an account that has administrator rights.  
...
5.  On the **Installation location** page, verify that sufficient free disk space is available, and then click **Next**. If necessary, click **Browse** to change the location in which you want to install the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] management server.  
...
7.  On the **Configure the Service Manager database** page, do the following:  
    ...
    1.  In **Database server**, type the name of the computer that is hosting the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] database, and then press the TAB key.  
