...
Management packs are used to direct and extend the functionality of [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)]. This topic uses projectors as an example for describing the various sections of a management pack and for defining the various objects that are needed for managing projectors in an organization.  
...
## Creating a Form  
 [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] forms are based on Windows Presentation Framework \(WPF\) forms. [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] extends WPF with simple attributes that are added to the XML definition and allow [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] to bind data from the management pack to the form.  
  
 [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] forms can be created by using several different tools, including Microsoft Visual Studio or Microsoft Expression Blend. Because the forms are XML\-based, they can also be defined by using any XML editor.  
...
```  
 ...
 The second two **Category** elements in the example management pack are used to make the projector condition enumeration appear in the **Lists** view in the **Authoring** pane in the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)]. This enables the user to customize the values:  
...
```  
 ...
 In the preceding example, the **ElementID** attribute contains a reference to the view that was created. The **Folder** attribute points to a **Folders.Projectors** folder, which in turn has its root as defined in the **Configuration Management** workspace of the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)]. This root folder is defined in the Configuration Management management pack.  
...
## Importing a Management Pack by Using a Windows PowerShell Cmdlet  
 You can use the Windows PowerShell [Import\-SCSMManagementPack](http://go.microsoft.com/fwlink/p/?LinkID=225396) cmdlet to import a [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] management pack, for example:  
  
```  
Import-SCSMManagementPack MyServiceManager.ManagementPack.xml  
```  
  
 This document does not describe how to import and use management packs in the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)]. For information about using management packs in the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)], see [Using Management Packs in System Center 2012 \- Service Manager](http://go.microsoft.com/fwlink/p/?LinkID=233228).  
