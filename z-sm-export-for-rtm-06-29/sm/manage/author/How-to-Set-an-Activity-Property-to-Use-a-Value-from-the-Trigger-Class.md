...
Use this procedure in the [!INCLUDE[smatfull2012](../../../sm/manage/author/includes/smatfull2012_md.md)] to set a property to retrieve its value from the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] class used to trigger the workflow. You cannot use this method with a workflow that has a Timer trigger.  
