...
A **Label** control is used in the [!INCLUDE[smatfull2012](../../../sm/manage/author/includes/smatfull2012_md.md)] for displaying a label on a form. You can modify the properties of the **Label** control to customize characteristics such as the text string that the label displays.  
