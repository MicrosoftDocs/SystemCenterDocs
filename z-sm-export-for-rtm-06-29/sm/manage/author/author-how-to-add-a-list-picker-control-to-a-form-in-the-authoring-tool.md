...
The **List Picker** control in the [!INCLUDE[smatfull2012](../../../sm/manage/author/includes/smatfull2012_md.md)] is a [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)] custom control that is used for selecting an item from a prepopulated list of items. You can modify properties of the **List Picker** control to customize the characteristics of the control.  
 ...
 To add list items to a newly created list, you must use the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)]. You cannot use the [!INCLUDE[scauthoringshort](../../../sm/manage/author/includes/scauthoringshort_md.md)] to add list items to a newly created list. [!INCLUDE[crabout](../../../sm/deploy/deploy-guide/includes/crabout_md.md)] using the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)] to add list items, see [How to Add a List Item](http://go.microsoft.com/fwlink/p/?LinkId=231881).  
