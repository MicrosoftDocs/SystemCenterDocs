...
Use the following guidelines and best practices when you are customizing classes in the [!INCLUDE[smatfull2012](../../../sm/manage/author/includes/smatfull2012_md.md)].  
  
## Naming Conventions for Type Definitions  
 The [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] schema model naming convention is based on the .NET namespaces naming convention.  
...
## Do Not Use Properties That Update Too Frequently  
 Property values should change rarely after they are first populated. A possible cause for frequent property value changes is a custom connector or any other customization that programmatically updates the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] database. These scenarios can potentially cause property values to update too frequently, such as every 10 to 15 minutes or less for a large number of objects.  
...
## Do Not Extend an Abstract Class  
 In [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)], you cannot extend an abstract class. If you need to extend an abstract class, you can do either of the following:  
