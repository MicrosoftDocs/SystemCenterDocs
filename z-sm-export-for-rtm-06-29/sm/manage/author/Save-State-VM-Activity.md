...
This activity in [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)] saves the state of a virtual machine and then stops the virtual machine.  
...
-   The Virtual Machine Manager console and [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] must be both installed on the same server.  
