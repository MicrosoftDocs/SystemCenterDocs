...
This activity adds a computer to a security group in Active Directory Domain Services \(AD DS\) in [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)]. The computer and the group must belong to the same domain, and all containers in the domain are searched.  
