...
Workflow activities are the building blocks of a workflow. You can use the procedures in this section to add activities to a workflow; remove, copy, and paste activities; and configure specialized activities to import [!INCLUDE[powshellshortname](../../../sm/manage/author/includes/powshellshortname_md.md)] scripts into your workflow.  
