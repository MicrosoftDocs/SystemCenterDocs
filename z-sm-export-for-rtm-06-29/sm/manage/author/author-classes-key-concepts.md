...
Objects in [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)] are *instances* of a particular base class. All instances of a base class have a common set of properties and common behavior.  
  
 Like all management pack elements, classes have *ID* and *Display Name* properties. In this documentation, “ID” refers to the unique name of the class that is seen only in the [!INCLUDE[scauthoringshort](../../../sm/manage/author/includes/scauthoringshort_md.md)], while “Name” and “Display Name” refer to the language\-specific name that appears in the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)].  
  
> [!NOTE]  
>  When you are creating a class, always ensure that class names are unique among management packs. If possible, use class names that are meaningful in your environment. You can determine whether a class name already exists by using the search feature in the **Class Browser** window of the [!INCLUDE[smatfull2012](../../../sm/manage/author/includes/smatfull2012_md.md)].  
...
## Base Classes and Inheritance  
 Every class must specify a *base class* that identifies an existing class that the new class will *specialize*. The management pack libraries that are included with [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] contain several classes that can be used as the base for custom classes in management packs. A management pack will typically have at least one class inheriting from a library class and potentially other classes inheriting from classes in the same management pack.  
 ...
 **Inheritance of properties between classes**  
 ...
 ![Inheritance of properties between classes](../../../sm/manage/author/media/ClassInheritance.gif "ClassInheritance")  
 ...
 **Hosting relationships for SQL Server 2008 classes**  
 ...
 ![Hosting relationship for SQL Server 2008 classes](../../../sm/manage/author/media/AuthGuide_SQLHostingRelationship.gif "AuthGuide\_SQLHostingRelationship")  
 ...
 **Sample database hosting relationships**  
 ...
 ![Sample Database Hosting Relationship](../../../sm/manage/author/media/AuthGuide_SampleDatabaseHosting.gif "AuthGuide\_SampleDatabaseHosting")  
