...
All customizations to objects and to functionality in [!INCLUDE[smshort12](../../../sm/deploy/deploy-guide/includes/smshort12_md.md)] are implemented by using management packs. This section describes management packs and how to use and manage them to implement various types of customizations using different customization methods.  
...
-   [Working with Management Packs in the Service Manager Console](../../../sm/manage/author/Working-with-Management-Packs-in-the-Service-Manager-Console.md)  
     ...
     Describes how to work with management packs in the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)].  
