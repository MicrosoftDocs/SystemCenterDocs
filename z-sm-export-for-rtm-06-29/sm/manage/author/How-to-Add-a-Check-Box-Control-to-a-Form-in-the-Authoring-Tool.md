...
A **Check Box** control in [!INCLUDE[smatfull2012](../../../sm/manage/author/includes/smatfull2012_md.md)] presents an option on the form, and lets the user choose that option. You can modify the properties of the **Check Box** control to customize characteristics such as the label that is displayed on the check box.  
