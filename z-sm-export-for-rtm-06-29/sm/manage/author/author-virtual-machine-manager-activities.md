...
Use virtual machine management activities in [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)] to build workflows that allow for creating and updating virtual machines. The virtual machine management activities support System Center Virtual Machine Manager \(VMM\) 2008 2.0.  
  
 The [!INCLUDE[smatfull2012](../../../sm/manage/author/includes/smatfull2012_md.md)] provides the following five default virtual machine management activities in the **VMM Activities** group in the **Activities Toolbox** pane.  
