...
This activity adds a user to a security group in Active Directory Domain Services \(AD DS\) in [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)]. The user and the group must belong to the same domain, and all the containers in the domain are searched.  
