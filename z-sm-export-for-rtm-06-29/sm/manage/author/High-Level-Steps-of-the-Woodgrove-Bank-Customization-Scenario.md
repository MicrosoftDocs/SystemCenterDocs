...
-   The form that represents the **Automated Activity: Add Computer To AD Group** class. Ken can use this form to enter information about the computer that is being added and the Active Directory group to which the computer should be added.  
 ...
 [!INCLUDE[crabout](../../../sm/deploy/deploy-guide/includes/crabout_md.md)] how to open the management pack, see [Step 1: Open the Woodgrove.AutomatedActivity.AddComputerToADGroupMP Management Pack](../Topic/Step%201:%20Open%20the%20Woodgrove.AutomatedActivity.AddComputerToADGroupMP%20Management%20Pack.md).  
...
## Step 2: Customize the Default Change Request Form  
 ...
 [!INCLUDE[crabout](../../../sm/deploy/deploy-guide/includes/crabout_md.md)] how to customize the default change request form, see [Step 2: Customize the Default Change Request Form](../Topic/Step%202:%20Customize%20the%20Default%20Change%20Request%20Form.md).  
...
## Step 3: Create the WF Workflow  
 ...
 [!INCLUDE[crabout](../../../sm/deploy/deploy-guide/includes/crabout_md.md)] how to create the workflow rule and the Windows Workflow Foundation \(WF\) Workflow, see [Step 3: Create the WF Workflow](../Topic/Step%203:%20Create%20the%20WF%20Workflow.md).  
  
## Step 4: Move the Assembly Files to the Service Manager Console  
 Ken moves the workflow assembly file and the form assembly file to the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] Program folder.  
  
 [!INCLUDE[crabout](../../../sm/deploy/deploy-guide/includes/crabout_md.md)] how to move the assembly files to the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] console, see [Step 4: Move the Assembly Files to the Service Manager Console](../Topic/Step%204:%20Move%20the%20Assembly%20Files%20to%20the%20Service%20Manager%20Console.md).  
...
## Step 5: Bundle and Import the Custom Management Pack to Service Manager  
 ...
 [!INCLUDE[crabout](../../../sm/deploy/deploy-guide/includes/crabout_md.md)] how to bundle and import the custom management pack into [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)], see [Step 5: Bundle and Import the Custom Management Pack to Service Manager](../Topic/Step%205:%20Bundle%20and%20Import%20the%20Custom%20Management%20Pack%20to%20Service%20Manager.md).  
...
## Step 6: Extend the Change Area Enumeration List  
 ...
 [!INCLUDE[crabout](../../../sm/deploy/deploy-guide/includes/crabout_md.md)] how to extend the change area enumeration list, see [Step 6: Extend the Change Area Enumeration List](../Topic/Step%206:%20Extend%20the%20Change%20Area%20Enumeration%20List.md).  
  
## Step 7: Create a New Task  
 Ken creates the **Start AD Users and Computers** task that starts the **AD Users and Computers** administration tool from the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)]. Ken can conveniently monitor the Active Directory group to which the new computer is being added.  
  
 [!INCLUDE[crabout](../../../sm/deploy/deploy-guide/includes/crabout_md.md)] how to create a new task, see [Step 7: Create a New Task](../Topic/Step%207:%20Create%20a%20New%20Task.md).  
...
## Step 8: Create a New View  
 ...
 [!INCLUDE[crabout](../../../sm/deploy/deploy-guide/includes/crabout_md.md)] how to create a new view, see [Step 8: Create a New View](../Topic/Step%208:%20Create%20a%20New%20View.md).  
...
## Step 9: Create a New Change Request Template  
 ...
 [!INCLUDE[crabout](../../../sm/deploy/deploy-guide/includes/crabout_md.md)] how to create a new change request template, see [Step 9: Create a New Change Request Template](../Topic/Step%209:%20Create%20a%20New%20Change%20Request%20Template.md).  
...
## Step 10: Create a Notification Template and Subscription \(Optional\)  
 ...
 [!INCLUDE[crabout](../../../sm/deploy/deploy-guide/includes/crabout_md.md)] how to create a notification template and subscription \(optional\), see [Step 10: Create a Notification Template and Subscription \(Optional\)](../Topic/Step%2010:%20Create%20a%20Notification%20Template%20and%20Subscription%20\(Optional\).md).  
...
## Step 11: Use the New Compliance Change Request Process  
 ...
 [!INCLUDE[crabout](../../../sm/deploy/deploy-guide/includes/crabout_md.md)] how to use the new compliance change request process, see [Step 11: Use the New Compliance Change Request Process](../Topic/Step%2011:%20Use%20the%20New%20Compliance%20Change%20Request%20Process.md).  
