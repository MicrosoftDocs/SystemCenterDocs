...
Use this procedure to add an activity to a workflow from the **Activities Toolbox** pane in the [!INCLUDE[smatfull2012](../../../sm/manage/author/includes/smatfull2012_md.md)].  
