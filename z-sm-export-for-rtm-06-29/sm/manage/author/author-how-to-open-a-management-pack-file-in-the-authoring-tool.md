...
If you want to customize objects that are defined in a management pack in [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)], you have to open the management pack file that contains these objects in the [!INCLUDE[smatfull2012](../../../sm/manage/author/includes/smatfull2012_md.md)]. You can use the following procedure to open a management pack file in the [!INCLUDE[scauthoringshort](../../../sm/manage/author/includes/scauthoringshort_md.md)].  
  
 The **Management Pack Explorer** pane in the [!INCLUDE[scauthoringshort](../../../sm/manage/author/includes/scauthoringshort_md.md)] displays all the management packs that are open. A management pack that you open and change is designated with an asterisk \(\*\)—for example, CustomMP\*—until it is saved.  
...
-   All the management packs in the Library folder in the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] installation folder, for example, in the \\Program Files \(x86\)\\Microsoft System Center\\Service Manager 2012 Authoring\\Library folder  
  
 This is important because the definitions from all open management packs co\-exist in the [!INCLUDE[scauthoringshort](../../../sm/manage/author/includes/scauthoringshort_md.md)]; therefore, they cannot contradict each other.  
...
2.  Click **Service Manager Authoring Tool**, and wait for the [!INCLUDE[scauthoringshort](../../../sm/manage/author/includes/scauthoringshort_md.md)] to open.  
  
3.  In the [!INCLUDE[scauthoringshort](../../../sm/manage/author/includes/scauthoringshort_md.md)], on the menu bar, click **File**, and then click **Open**.  
