...
The **User Picker** control is a System Center 2012 - Service Manager custom control that is used for choosing a user from a drop\-down list of users. You can modify the properties of the **User Picker** control in the System Center 2016 - Service Manager Authoring Tool to customize characteristics such as the layout and the list of users to bind to.  
