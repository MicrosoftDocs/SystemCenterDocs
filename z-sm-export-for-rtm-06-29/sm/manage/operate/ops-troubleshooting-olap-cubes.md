...
The following sections describe common problems that you might need to troubleshoot online analytical processing \(OLAP\) data cubes in the [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)] data warehouse.  
...
## OLAP Cube Management Pack Deployment Failures  
 ...
 [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] does not have a Dimension Usage tab capability. Therefore, you will have to look at BIDS to determine exactly which dimensions can filter on a particular cube.  
