...
Online analytical processing \(OLAP\) cube deployment uses the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] deployment infrastructure to create OLAP cubes in the SQL Server Analysis Services \(SSAS\) database.  
