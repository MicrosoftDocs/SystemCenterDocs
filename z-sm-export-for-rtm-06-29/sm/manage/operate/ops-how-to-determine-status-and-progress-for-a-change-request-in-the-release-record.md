...
5.  You can view records by using any of the following methods:  
    ...
    -   Using search anywhere in the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)]:  
