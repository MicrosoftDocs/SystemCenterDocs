...
The Operations Guide for Microsoft [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)] provides information about using the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)] for day\-to\-day tasks that you perform to manage service desk functions for your organization’s computer infrastructure. This guide provides detailed procedures for the following tasks:  
...
-   [Using Data Warehouse Reporting and Analytics in System Center 2012 \- Service Manager](../../../sm/manage/operate/Using-Data-Warehouse-Reporting-and-Analytics-in-System-Center-2012---Service-Manager.md)  
     ...
     Describes how standard reports and OLAP data cubes are used to view data and trends across your [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] environment.  
