...
5.  Open the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)], select the **Reporting** workspace, and then navigate to the folder that contains the report.  
