---
title: How to Complete or Fail a Manual Activity
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 5d552d91-3bab-4fc1-8f10-1589bf4098fc
...
You can use the following procedures to complete or fail a manual activity in [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)] and then validate that the manual activity is complete or failed.  
