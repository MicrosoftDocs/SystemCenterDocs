...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 37a6b642-7b1f-47d0-b9cc-7efd3c4a2dbe
...
End users often create service requests in [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)] by accessing the service catalog from the [!INCLUDE[smssp](../../../sm/deploy/deploy-guide/includes/smssp_md.md)] or by submitting email requests. However, you can use the following procedure to manually create a new service request in the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)]. For example, you might want to manually create a new service request if a user contacts the help desk by telephone. In the following example, you can update any information that you want to as you complete the form.  
  
### To create a new service request using the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)]  
  
1.  In the [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)], expand **Work Items**, expand **Service Request Fulfillment**, and then select a subnode, such as **Assigned To Me**.  
