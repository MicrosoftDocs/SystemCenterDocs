...
Before you can create and deploy dashboards for use on the [!INCLUDE[smssp](../../../sm/deploy/deploy-guide/includes/smssp_md.md)] in [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)], you must configure Microsoft SharePoint 2010 and then install Dashboard Designer.  
