---
title: How to Add Release Package Information to a Release Record
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 550d48b5-c557-4b3d-8de0-1d87d67c9ad5
...
In [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)], the Release Manager XE "Release Manager"  can add release package information for a release record using the following procedure. The release package normally contains the build and environment that the release is tested with.  
