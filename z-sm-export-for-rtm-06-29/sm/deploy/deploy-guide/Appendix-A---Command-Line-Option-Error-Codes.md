...
The following is a list of the error codes that are used in the command\-line installation of [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)].  
