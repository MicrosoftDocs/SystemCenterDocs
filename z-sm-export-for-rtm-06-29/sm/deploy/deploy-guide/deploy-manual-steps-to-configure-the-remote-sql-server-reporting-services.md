...
3.  Start a second instance of Windows Explorer, locate the drive that contains the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] installation media, and then open the Prerequisites folder.  
