...
This section describes how to deploy [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)] using command\-line parameters. For easier reading, the command\-line examples in this guide list each command\-line parameter on its own line. If you copy these examples, you must remove the carriage returns\/line\-feeds \(CRs\/LFs\) from each line before you can run the commands.  
...
|||  
|-|-|  
|**\/ProductKey**|If this parameter is omitted, [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] is installed as an evaluation edition with an evaluation period of 180 days.|  
|**\/Installpath**|If this parameter is omitted, [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] is installed in the default folder and path:<br /><br /> \[drive name\]:\\Program Files\\Microsoft System Center\\Service Manager 2012.|  
...
## Before you run the command line  
 To help prevent an installation failure, perform the following steps on the computer where you will be installing [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)]:  
...
## Determining When Installation Is Complete  
 When installation of either the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] management server or the data warehouse management server is complete, an event with Event ID 1033 is written into the Application Event log, as shown in the following illustration.  
  
 ![Command Line Install Event Log](../../../sm/deploy/deploy-guide/media/CommandLineInstallEventLog.jpg "CommandLineInstallEventLog")  
Event Viewer  
...
-   [How to Deploy a Service Manager Management Server Using the Command Line](../../../sm/deploy/deploy-guide/How-to-Deploy-a-Service-Manager-Management-Server-Using-the-Command-Line.md)  
     ...
     Describes how to install a [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] management server using the command line.  
...
-   [How to Deploy a Service Manager Console Using the Command Line](../../../sm/deploy/deploy-guide/How-to-Deploy-a-Service-Manager-Console-Using-the-Command-Line.md)  
     ...
     Describes how to install a [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)] using the command line.  
...
-   [How to Deploy the Service Manager Self\-Service Portal Using the Command Line](../../../sm/deploy/deploy-guide/How-to-Deploy-the-Service-Manager-Self-Service-Portal-Using-the-Command-Line.md)  
     ...
     Describes how to install the [!INCLUDE[smssp](../../../sm/deploy/deploy-guide/includes/smssp_md.md)] using the command line.