...
When you use certificates with the [!INCLUDE[smssp](../../../sm/deploy/deploy-guide/includes/smssp_md.md)] in [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)], you can use this procedure to connect directly to the web content server using a browser. This gives you the opportunity to make sure that the URL you specify for the web content server does not result in any certificate warnings.  
 ...
 ![Web Content Server](../../../sm/deploy/deploy-guide/media/DirectConnectiontoaWebContentServer.gif "DirectConnectiontoaWebContentServer")  
