...
If you upgrade SQL Server 2008 R2 to SQL 2012 after [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] SP1 installation, you must manually copy the Microsoft.EnterpriseManagement.Reporting.Code.dll file in order for SQL Server Reporting Services \(SSRS\) to function properly.  
