...
There are two workaround procedures that you can use to try to resolve the issue in which an upgrade to System Center 2012 - Service Manager SP1 fails as a result of Configuration service Startup timing out. You can:  
