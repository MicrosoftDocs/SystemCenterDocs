...
Use the following procedure to restore the production [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] database using Microsoft SQL Server 2008 R2.  
