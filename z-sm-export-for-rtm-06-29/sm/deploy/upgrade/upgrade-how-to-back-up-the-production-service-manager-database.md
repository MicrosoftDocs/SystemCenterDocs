...
Use the following procedure to back up the production [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] database in Microsoft SQL Server 2008 R2.  
