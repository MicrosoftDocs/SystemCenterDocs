...
This topic describes how to restart the Data Access service if it fails to start after an upgrade to [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)] SP1. After the upgrade, you will also have to start the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] workflows and restart the data warehouse jobs. This topic also describes how to stop and then start SQL Server Reporting Services \(SSRS\) after an upgrade.  
...
1.  On the computer that hosts the [!INCLUDE[smshort12](../../../sm/deploy/deploy-guide/includes/smshort12_md.md)] management server, on the Windows desktop, click **Start**, and then click **Run**.  
...
2.  Type the following commands and then press Enter after each command.  
    ...
    > [!NOTE]  
    >  It is assumed in the following command examples that [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] was installed in its default location on the C: drive. If necessary, change directories to the location where you installed [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)].  
...
## Stop and Then Start SSRS  
 After you perform an upgrade to [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)] SP1, use the following procedure to stop and then start SSRS.  
