...
## Determine when the deployment is complete  
 Because you need to allow enough time for the management pack deployment process to be completed, you will have to determine when that process is complete. You can use the following procedure in [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] to determine when the process is complete.  
