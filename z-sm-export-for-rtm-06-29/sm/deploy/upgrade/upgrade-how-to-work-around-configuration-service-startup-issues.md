...
There are two workaround procedures that you can use to try to resolve the issue in which an upgrade to [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)] SP1 fails as a result of Configuration service Startup timing out. You can:  
