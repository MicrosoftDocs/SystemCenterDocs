...
For information about the specific versions of SQL Server that are supported in System Center 2016 - Service Manager see [Software Requirements for Service Manager](Software-Requirements-for-Service-Manager.md).
