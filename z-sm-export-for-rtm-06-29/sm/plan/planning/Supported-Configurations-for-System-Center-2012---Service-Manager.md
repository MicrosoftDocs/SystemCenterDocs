...
This section includes information about the hardware and software requirements for [!INCLUDE[smlong12](../../../sm/deploy/deploy-guide/includes/smlong12_md.md)]. [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] has been tested up to the workload described in this topic, based on the recommended hardware requirements in this guide. This environment contains one [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] management server supporting 80 to 100 concurrent [!INCLUDE[smcons](../../../sm/deploy/deploy-guide/includes/smcons_md.md)]s. High\-performance storage using 15,000\-RPM SCSI drives is used on the database servers.  
...
-   5,000 incidents per week with three months of retention, for a total of 60,000 incidents in the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] database for the 20,000\-computer configuration, and 2.5 times that for the 50,000\-computer configuration.  
  
-   1,000 change requests a week with three months of retention, for a total of 12,000 change requests in the [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] database for the 20,000\-computer configuration, and 2.5 times that for the 50,000\-computer configuration.  
  
 Using a slow storage subsystem or insufficient memory can reduce [!INCLUDE[smshort](../../../sm/deploy/deploy-guide/includes/smshort_md.md)] performance significantly.  
...
-   [Hardware Requirements for System Center 2012 \- Service Manager](../../../sm/plan/planning/Hardware-Requirements-for-System-Center-2012---Service-Manager.md)  
     ...
     Describes the hardware requirements for [!INCLUDE[smshort12](../../../sm/deploy/deploy-guide/includes/smshort12_md.md)].  
...
-   [Software Requirements for System Center 2012 \- Service Manager](../../../sm/plan/planning/Software-Requirements-for-System-Center-2012---Service-Manager.md)  
     ...
     Describes the software requirements for [!INCLUDE[smshort12](../../../sm/deploy/deploy-guide/includes/smshort12_md.md)].  
